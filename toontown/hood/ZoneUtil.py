...
def isLawOfficeInteriorZone(zoneId):
    return zoneId in (LawbotStageIntA, LawbotStageIntB, LawbotStageIntC, LawbotStageIntD, LawbotStageIntsEven)
...
def getWhereName(zoneId, isToon):
    if tutorialDict:
        ...
        if isCogHQZone(zoneId):
            ...
            elif getHoodId(zoneId) == LawbotHQ and suffix in (300, 400, 500, 600, 700):
                where = 'stageInterior'
