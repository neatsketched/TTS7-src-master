...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.title = DirectLabel(guiId='ToontownLoadingScreenTitle', parent=self.waitBar, relief=None, pos=(1.7, 5, .21), text='', textMayChange=1, text_scale=0.1, text_fg=(0.85, 0, 0, 1), text_align=TextNode.ACenter, text_font=ToontownGlobals.getSignFont())
    ...
    def begin(self, range, label, gui, tipCategory, zoneId):
        ...
        if gui:
            ...
            self.title.setPos(base.a2dRight/1.12, 0, 0.21)
