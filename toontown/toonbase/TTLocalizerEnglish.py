...
QuestsCogQuestSCStringS = 'I need to defeat %(SevenName)s%(SevenLoc)s.'
QuestsCogQuestSCStringP = 'I need to defeat some %(SevenName)s%(SevenLoc)s.'
...
QuestsRescueQuestSCStringS = 'I need to rescue a Sketched%(SketchedLoc)s.'
QuestsRescueQuestSCStringP = 'I need to rescue some Sketcheds%(SketchedLoc)s.'
...
ElevatorCashbotMint3 = 'Platinum Mint'
