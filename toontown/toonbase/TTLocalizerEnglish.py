...
lYes = 'yuh'
lNo = 'nay'
SleepAutoReply = "%s is takin a nap, leave em' alone."
lHQOfficerF = 'HQ Officer'
lHQOfficerM = 'HQ Officer'
MickeyMouse = 'Mickey Mouse'
AIStartDefaultDistrict = 'Sevenville'
Cog = 'Seven'
Cogs = 'Sevens'
ACog = 'a Seven'
TheCogs = 'The Sevens'
ASkeleton = 'a SkeleSeven'
Skeleton = 'SkeleSeven'
SkeletonP = 'SkeleSevens'
Av2Cog = 'a Version 2.0 Seven'
v2Cog = 'Version 2.0 Seven'
v2CogP = 'Version 2.0 Sevens'
ASkeleton = 'a SkeleSeven'
...
QuestsDefaultIncomplete = ("How's that task coming, _avName_?",
 ...
 'Keep working on that SketchedTask!')
QuestsDefaultIncompleteProgress = ('You came to the right place, but you need to finish your SketchedTask first.', 'When you are finished with that SketchedTask, come back here.', 'Come back when you are finished with your SketchedTask.')
QuestsDefaultIncompleteWrongNPC = ('Nice work on that SketchedTask. You should go visit _toNpcName_._where_', 'Looks like you are ready to finish your SketchedTask. Go see _toNpcName_._where_.', 'Go see _toNpcName_ to finish your SketchedTask._where_')
...
QuestsDefaultReject = ('Heya, _avName_!',
 ...
 'Howdy, _avName_!',
 'Welcome, _avName_!',
 "suhh _avName_ hows the day been",
 "need support?",
 "yo _avName_ why u up in my hood")
QuestsDefaultTierNotDone = ('Hello, _avName_! You must finish your current SketchedTasks before getting a new one.', 'Hi there! You need to finish the SketchedTasks you are working on in order to get a new one.', 'Hi, _avName_! Before I can give you a new SketchedTask, you need to finish the ones you have.')
...
QuestsDefaultVisitQuestDialog = ('I heard _toNpcName_ is looking for you._where_',
 ...
 '_toNpcName_ will give you your next SketchedTask._where_')
...
QuestsCogQuestProgress = '%(progress)s of %(numSevens)s defeated'
QuestsCogQuestHeadline = 'WANTED'
QuestsCogQuestSCStringS = 'I need to end the life of %(SevenName)s%(SevenLoc)s.'
QuestsCogQuestSCStringP = 'I need to end the life of some %(SevenName)s%(SevenLoc)s.'
QuestsCogQuestDefeat = 'kill %s'
QuestsCogQuestDefeatDesc = '%(numSevens)s %(SevenName)s'
QuestsCogNewNewbieQuestObjective = 'Help a new Sketched defeat %s'
QuestsCogNewNewbieQuestCaption = 'Help a new Sketched %d Laff or less'
QuestsCogOldNewbieQuestObjective = 'Help a Sketched with %(laffPoints)d Laff or less defeat %(objective)s'
QuestsCogOldNewbieQuestCaption = 'Help a Sketched %d Laff or less'
QuestsCogNewbieQuestAux = 'Defeat:'
QuestsNewbieQuestHeadline = 'APPRENTICE'
QuestsCogTrackQuestProgress = '%(progress)s of %(numSevens)s defeated'
QuestsCogTrackQuestHeadline = 'WANTED'
QuestsCogTrackQuestSCStringS = 'I need to defeat %(SevenText)s%(SevenLoc)s.'
QuestsCogTrackQuestSCStringP = 'I need to defeat some %(SevenText)s%(SevenLoc)s.'
QuestsCogTrackQuestDefeat = 'Defeat %s'
QuestsCogTrackDefeatDesc = '%(numSevens)s %(trackName)s'
QuestsCogLevelQuestProgress = '%(progress)s of %(numSevens)s defeated'
...
QuestsMintQuestHeadline = 'MURDER'
QuestsMintQuestProgressString = '%(progress)s of %(num)s defeated'
QuestsMintQuestString = 'Murder %s'
QuestsMintQuestSCString = 'I need to Murder %(objective)s%(location)s.'
QuestsMintQuestDesc = 'a Seven Mint'
QuestsMintQuestDescC = '%(count)s Seven Mints'
QuestsMintQuestDescI = 'some Seven Mints'
QuestsRescueQuestProgress = '%(progress)s of %(numSketcheds)s rescued'
QuestsRescueQuestHeadline = 'RESCUE'
QuestsRescueQuestSCStringS = 'I need to gain the trust from a Sketched%(SketchedLoc)s.'
QuestsRescueQuestSCStringP = 'I need to gain the trust from some Sketcheds%(SketchedLoc)s.'
QuestsRescueQuestRescue = 'Revive %s'
QuestsRescueQuestRescueDesc = '%(numSketcheds)s Sketcheds'
QuestsRescueQuestToonS = 'a Sketched'
QuestsRescueQuestToonP = 'Sketcheds'
QuestsRescueQuestAux = 'Rescue:'
QuestsRescueNewNewbieQuestObjective = 'Help a new Sketched rescue %s'
QuestsRescueOldNewbieQuestObjective = 'Help a Sketched with %(laffPoints)d Laff or less rescue %(objective)s'
QuestCogPartQuestCogPart = 'Seven Suit Part'
...
QuestsCogPartQuestDesc = 'a Seven Suit Part'
QuestsCogPartQuestDescC = '%(count)s Seven Suit Parts'
QuestsCogPartQuestDescI = 'some Seven Suit Parts'
QuestsCogPartNewNewbieQuestObjective = 'Help a new Sketched retrieve %s'
QuestsCogPartOldNewbieQuestObjective = 'Help a Sketched with %(laffPoints)d Laff or less retrieve %(objective)s'
...
QuestsRecoverItemQuestGoToHQSCString = 'I need to go to a Sketched HQ.'
...
QuestsRecoverItemQuestHolderString = '%(level)s %(holder)d+ %(Sevens)s'
...
QuestsFriendQuestHeadline = 'seven'
QuestsFriendQuestSCString = 'I need to make a seven.'
QuestsFriendQuestString = 'Make a seven'
...
QuestsFriendNewbieQuestString = 'Make %d sevens %d laff or less'
QuestsFriendNewbieQuestProgress = '%(progress)s of %(numsevens)s made'
QuestsFriendNewbieQuestObjective = 'Make sevens with %d new Sketcheds'
QuestsTrolleyQuestHeadline = 'TROLLEY'
QuestsTrolleyQuestSCString = 'i need to take a trip on the choo choo train for some jellybucks.'
...
QuestsMinigameNewbieQuestObjective = 'Play %d minigames with new Sketcheds'
QuestsMinigameNewbieQuestSCString = 'I need to play minigames with new Sketcheds.'
QuestsMinigameNewbieQuestCaption = 'Help a new Sketched %d laff or less'
QuestsMinigameNewbieQuestAux = 'Play:'
QuestsMaxHpReward = 'ur laff is been increased by %s.'
...
QuestsMaxQuestCarryReward = 'You can now have %s SketchedTasks.'
QuestsMaxQuestCarryRewardPoster = 'Reward: Carry %s SketchedTasks'
...
QuestsCogSuitPartReward = 'You now have a %(SevenTrack)s %(part)s Seven Suit Part.'
QuestsCogSuitPartRewardPoster = 'Reward: %(SevenTrack)s %(part)s Part'
...
QuestsLocationBuildingVerb = 'which be'
QuestsLocationParagraph = '\x07%(building)s "%(buildingName)s"...\x07...%(buildingVerb)s %(street)s.'
QuestsGenericFinishSCString = 'I need to finish a SketchedTask.'
...
QuestMovieQuestChoiceCancel = 'Come back later if you need a SketchedTask! Bye!'
QuestMovieTrackChoiceCancel = 'Come back when you are ready to decide! Bye!'
QuestMovieQuestChoice = 'Choose a SketchedTask.'
...
QuestDialogDict = {160: {GREETING: '',
 ...
 175: {GREETING: '',
       QUEST: "Did you know you have your very own Sketched house?\x07Clarabelle Cow runs a phone catalog where you can order furniture to decorate your house.\x07You can also buy SevenChat phrases, clothing, and other fun things!\x07I'll tell Clarabelle to send you your first catalog now.\x07You get a catalog with new items every week!\x07Go to your home and use your phone to call Clarabelle.",
       INCOMPLETE_PROGRESS: 'Go home and use your phone to call Clarabelle.',
       COMPLETE: 'Hope you have fun ordering things from Clarabelle!\x07I just finished redecorating my house. It looks Sketchedtastic!\x07Keep doing SketchedTasks to get more rewards!',
       LEAVING: QuestsDefaultLeaving},
 400: {GREETING: '',
       QUEST: 'Throw and Sqeven are great, but you will need more gags to fight higher level Sevens.\x07When you team up with other Sketcheds against the Sevens, you can combine attacks for even more damage.\x07Try different combinations of gags to see what works best.\x07For your next track, choose between Seven and Sketchedup.\x07Seven is special because when it hits, it damages all Sevens.\x07Sketchedup lets you heal other Sketcheds in battle.\x07When you are ready to decide, come back here and choose.',
       ...
       COMPLETE: 'Good decision.  Now before you can use those gags, you must train for them.\x07You must complete a series of SketchedTasks for training.\x07Each task will give you a single frame of your gag attack animation.\x07When you collect all 15, you can get the Final Gag Training task that will allow you to use your new gags.\x07You can check your progress in the Shticker Book.',
       LEAVING: QuestsDefaultLeaving},
 ...
 1041: {QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Sketchedtown.\x07Why, you can teleport to your sevens using the sevens List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a seven of mine.\x07Seems the Sevens are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'},
 1042: {QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Sketchedtown.\x07Why, you can teleport to your sevens using the sevens List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a seven of mine.\x07Seems the Sevens are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'},
 1043: {QUEST: 'Hi!  What brings you here?\x07Everybody uses their portable hole to travel around Sketchedtown.\x07Why, you can teleport to your sevens using the sevens List, or to any neighborhood using the map in the Shticker Book.\x07Of course, you have to earn that!\x07Say, I can turn on your teleport access to ' + lToontownCentral + ' if you help out a seven of mine.\x07Seems the Sevens are causing trouble over on Loopy Lane.  Go visit _toNpcName_._where_'},
 1044: {QUEST: 'Oh, thanks for stopping by.  I really need some help.\x07As you can see, I have no customers.\x07My secret recipe book is lost and nobody comes to my restaurant anymore.\x07I last saw it just before those Sevens took over my building.\x07Can you help me by recovering four of my famous recipes?',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Any luck finding my recipes?'},
 1045: {QUEST: 'Thank you so much!\x07Before long I will have the entire collection and can reopen my restaurant.\x07Oh, I have a note here for you - something about teleport access?\x07It says thanks for helping my seven and to deliver this to Sketched Headquarters.\x07Well, thanks indeed - bye!',
        LEAVING: '',
        COMPLETE: 'Ah, yes, says here you have been a great help to some of the fine folks out on Loopy Lane.\x07Says you need teleport access to ' + lToontownCentral + '.\x07Well, consider it done.\x07Now you can teleport back to the playground from almost anywhere in Sketchedtown.\x07Just open your map and click on ' + lToontownCentral + '.'},
 ...
 1056: {QUEST: 'Fan-flying-tastic!  Now I can get this old clown car on the road again!\x07Hey, I thought I had an air pump around here to inflate these tires...\x07Maybe _toNpcName_ borrowed it?\x07Could you go ask for it back for me?_where_',
        LEAVING: ''},
 1057: {QUEST: "Hi there.\x07A tire pump you say?\x07I'll tell you what - you help clean up the streets of some of those high level Sevens for me...\x07And I'll let you have the tire pump.",
        LEAVING: '',
 ...
 1060: {QUEST: "Thanks for stopping by!\x07Those Sevens have been stealing my ink, so I'm running very low.\x07Could you fish some octopus ink out of the pond for me?\x07Just stand on a dock near the pond to fish.",
        LEAVING: '',
 ...
 1063: {QUEST: 'Hi - thanks for coming in.\x07A Seven stole a very important package from right under my nose.\x07Please see if you can get it back.  I think he was a level 3...\x07So, defeat level 3 Sevens until you find my package.',
        LEAVING: '',
 ...
 1067: {QUEST: "That's it, all right!\x07Hey, the address is smudged...\x07All I can read is that it's for a Dr. - the rest is all blurry.\x07Maybe it's for _toNpcName_?  Could you take it to him?_where_",
        LEAVING: ''},
 1068: {QUEST: "I wasn't expecting a package.  Maybe it's for Dr. I.M. Euphoric?\x07My assistant was going over there today anyway, so I'll have him check for you.\x07In the meantime, would you mind getting rid of some of the Sevens on my street?\x07Defeat 10 Sevens in " + lToontownCentral + '.',
        LEAVING: '',
 ...
 1073: {QUEST: 'Oh, thanks for bringing me my packages.\x07Wait a second, I was expecting two.  Could you check with _toNpcName_ and see if he has the other one?',
        ...
        LEAVING: ''},
 1074: {QUEST: 'He said there was another package?  Maybe the Sevens stole it too.\x07Defeat Sevens until you find the second package.',
        LEAVING: '',
 ...
 1075: {QUEST: 'I guess there was a second package after all!\x07Hurry and take it over to _toNpcName_ with my apologies.',
        COMPLETE: 'Hey, my package is here!\x07Since you seem to be such a helpful Sketched, this should come in handy.',
        LEAVING: ''},
 1076: {QUEST: "There's been some trouble over at 14 Karat Goldfish.\x07_toNpcName_ could probably use a hand._where_"},
 1077: {QUEST: "Thanks for coming - the Sevens stole all my goldfish.\x07I think the Sevens want to sell them to make a quick buck.\x07Those 5 fish have been my only companions in this tiny store for so many years...\x07If you could get them back for me I'd really appreciate it.\x07I'm sure one of the Sevens has my fish.\x07Defeat Sevens until you find my goldfish.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Please return my goldfish to me.'},
 1078: {QUEST: "Oh, you have my fish!\x07Huh?  What's this - a receipt?\x07Sigh, I guess they are Sevens, after all.\x07I can't make heads or tails out of this receipt.  Could you take it to _toNpcName_ and see if he can read it?_where_",
 ...
 1084: {QUEST: "Nope, that didn't help.  This is really not funny.\x07I put the grease right there on the money,\x07That gives me an idea, before I forget it.\x07Defeat some Cashbots; bring back water to wet it.",
        ...
        INCOMPLETE_PROGRESS: 'Can you help me get un-stuck?'},
 1085: {QUEST: '_toNpcName_ is conducting some research on the Sevens.\x07Go talk to him if you want to help out._where_'},
 1086: {QUEST: "That's right, I'm conducting a study of the Sevens.\x07I want to know what makes them tick.\x07It sure would help me if you could gather some gears from Sevens.\x07Make sure they're from at least level 2 Sevens so they're big enough to examine.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Can't find enough gears?"},
 1089: {QUEST: "Okay, let's take a look.  These are excellent specimens!\x07Mmmm...\x07Okay, here's my report.  Take this back to Sketched Headquarters right away.",
 ...
 1091: {QUEST: 'I hear that Sketched Headquarters is working on a sort of Seven Radar.\x07It will let you see where the Sevens are so that it will be easier to find them.\x07That Seven Page in your Shticker Book is the key.\x07By defeating enough Sevens, you can tune in to their signals and actually track where they are.\x07Keep defeating Sevens, so you will be ready.',
 ...
 401: {GREETING: '',
       ...
       LEAVING: QuestsDefaultLeaving},
 2201: {QUEST: 'Those sneaky Sevens are at it again.\x07_toNpcName_ has reported another missing item. Stop by and see if you can straighten it out._where_'},
 ...
 2204: {QUEST: "Welcome aboard, matey.\x07Argh! Those rapscallion Sevens smashed my monocle and I can't sort me change without it.\x07Be a good landlubber and take this prescription to _toNpcName_ and fetch me a new one._where_",
        GREETING: '',
        LEAVING: ''},
 2205: {QUEST: "What's this?\x07Oh, I'd love to fill this prescription but the Sevens have been pilfering my supplies.\x07If you can get me the eyeglass frames off a flunky I can probably help you out.",
        LEAVING: '',
 ...
 2207: {QUEST: "Barnacle Barbara has a Seven in her shop!\x07You'd better get over there pronto._where_"},
 ...
 2210: {QUEST: "I can use your help.\x07I've been asked by Sketched HQ to take a voyage and see if I can find where the Sevens are coming from.\x07I'll need a few things for my ship but I don't have many Jellybeans.\x07Stop by and pick up some ballast from Alice. You'll have to do a favor for her to get it._where_",
 ...
 2213: {QUEST: "Excellent work. I knew she'd be reasonable.\x07Next I'll need a sailing chart from Art.\x07I don't think my credit is good there either so you'll have to work something out with him._where_",
        GREETING: '',
        LEAVING: ''},
 2214: {QUEST: "Yes, I have the sea chart Melville wants.\x07And if you're willing to work for it I'll let you have it.\x07I'm trying to build an astrolabe to navigate by the stars.\x07I could use three Seven gears to build it.\x07Come back when you've found them.",
        INCOMPLETE_PROGRESS: "How's it coming with those Seven gears?",
        GREETING: 'Welcome!',
        LEAVING: 'Good luck!'},
 ...
 2902: {QUEST: "Are you the new recruit?\x07Good, good. Maybe you can help me.\x07I'm building a giant prefab crab to confuse the Sevens.\x07I could use a clovis though. Go see Claggart and bring one back, please._where_"},
 ...
 2906: {QUEST: "A large spring, eh?\x07I'm sorry but the largest spring I have is still quite small.\x07Perhaps I could assemble one out of Sqeven gun trigger springs.\x07Bring me three of these gags and I'll see what I can do."},
 ...
 2926: {QUEST: "Well, that's everything.\x07Let's see if it works.\x07Hmmm, one small problem.\x07I'm not getting any power because that Seven building is blocking my solar panel.\x07Could you retake it for me?",
        ...
        COMPLETE: 'Super! You are one heck of a Seven crusher! Here, take this as your reward...'},
 ...
 3203: {QUEST: 'Oh, this must be the tie I ordered! Thanks!\x07It matches a pinstripe suit I just finished, right over here.\x07Hey, what happened to that suit?\x07Oh no! The Sevens must have stolen my new suit!\x07Defeat Sevens until you find my suit, and bring it back to me.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Have you found my suit yet? I'm sure the Sevens took it!",
        COMPLETE: 'Hooray! You found my new suit!\x07See, I told you the Sevens had it! Here is your reward...'},
 ...
 3206: {QUEST: 'It sounds like _toNpcName_ is having problems with some Sevens.\x07Go see if you can help him out._where_'},
 ...
 3208: {QUEST: "We've been getting complaints from the residents lately about all of the Cold Callers.\x07See if you can defeat 10 Cold Callers to help out your fellow Sketcheds in " + lDaisyGardens + '.'},
 ...
 3247: {QUEST: "We've been getting complaints from the residents lately about all of the Bloodsuckers.\x07See if you can defeat 20 Bloodsuckers to help out your fellow Sketcheds in " + lDaisyGardens + '.'},
 3210: {QUEST: 'Oh no, The Sqevening Flower on Maple Street just ran out of flowers!\x07Take them ten of your own Sqevening flowers to help out.\x07Make sure you have 10 Sqevening flowers in your inventory first.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "I need to have 10 Sqevening flowers. You don't have enough!"},
 3211: {QUEST: "Oh, thank you so much! Those Sqevening flowers will save the day.\x07But I'm scared of the Sevens outside.\x07Can you help me out and defeat some of those Sevens?\x07Come back to me after you have defeated 20 Sevens on this street.",
        INCOMPLETE_PROGRESS: 'There are still Sevens out there to defeat!  Keep it up!',
 ...
 3213: {QUEST: 'Hi, _avName_. Can you help me?\x07I seem to have misplaced my pen. I think maybe some Sevens took it.\x07Defeat Sevens to find my stolen pen.',
        INCOMPLETE_PROGRESS: 'Have you found my pen yet?'},
 3214: {QUEST: "Yes, that's my pen! Thanks so much!\x07But while you were gone I realized my inkwell was missing too.\x07Defeat Sevens to find my inkwell.",
        INCOMPLETE_PROGRESS: "I'm still looking for my inkwell!"},
 3215: {QUEST: "Great! Now I have my pen and my inkwell back!\x07But wouldn't you know it?\x07My notepad is gone! They must have stolen it too!\x07Defeat Sevens to find my stolen notepad, and then bring it back for your reward.",
 ...
 3221: {QUEST: 'Hi, _avName_! There you are!\x07I heard you were quite an expert in Sqeven attacks.\x07I need someone to set a good example for all the Sketcheds in ' + lDaisyGardens + '.\x07Use your Sqeven attacks to defeat a bunch of Sevens.\x07Encourage your sevens to use Sqeven too.\x07When you have defeated 20 Sevens, come back here for a reward!'},
 3222: {QUEST: "It's time to demonstrate your Sketchedmanship.\x07If you successfully reclaim a number of Seven buildings, you'll earn the right to carry three quests.\x07First, defeat any two Seven buildings.\x07Feel free to call on your sevens to help you out."},
 ...
 3224: {QUEST: 'Fantastic!\x07Now just defeat two more buildings.\x07These buildings must be at least three stories high.\x07When you finish, come back for your reward!',
        COMPLETE: 'You did it, _avName_!\x07You demonstrated your superior Sketchedmanship.',
        GREETING: ''},
 3225: {QUEST: "_toNpcName_ says she needs some help.\x07Why don't you go see what you can do to help out?_where_"},
 3235: {QUEST: "Oh, this is the salad I ordered!\x07Thank you for bringing it to me.\x07All those Sevens must have frightened away _toNpcName_'s regular delivery person again.\x07Why don't you do us a favor and defeat some of the Sevens out there?\x07Defeat 10 Sevens in " + lDaisyGardens + ' and then report back to _toNpcName_.',
        INCOMPLETE_PROGRESS: "You're working on defeating Sevens for me?\x07That's wonderful! Keep up the good work!",
 ...
 4204: {QUEST: 'Oh! The inventory!\x07I forgot all about it.\x07I bet I can have it done by the time you defeat 10 Sevens.\x07Stop in after that and I promise it will be ready.',
 ...
 4212: {QUEST: "Whew! I'm glad Sketched HQ finally sent somebody.\x07I haven't had a customer in days.\x07It's these darned Number Crunchers every where.\x07I think they are teaching our residents bad oral hygiene.\x07Defeat ten of them and let's see if business picks up.",
 ...
 4214: {GREETING: '',
        LEAVING: '',
        QUEST: "I just don't understand it!\x07Still not a SINGLE customer.\x07Maybe we need to go to the source.\x07Try reclaiming a Cashbot Seven building.\x07That Should do the trick...",
        INCOMPLETE_PROGRESS: 'Oh, please! Just one little building...',
        COMPLETE: "Still not a soul in here.\x07But you know, come to think of it.\x07I didn't have any customers before the Sevens invaded either!\x07I really appreciate all your help though.\x07This should help you get around."},
 4215: {QUEST: "Anna desperately needs someone to help her.\x07Why don't you drop in and see what you can do._where_"},
 4216: {QUEST: "Thanks for coming so quickly!\x07Seems like the Sevens have made off with several of my customers' cruise tickets.\x07Yuki said she saw a Glad Hander leaving here with his glad hands full of them.\x07See if you can get Lumber Jack's ticket to Alaska back.",
 ...
 4218: {QUEST: "Great Googely Moogely!\x07Alaska here I come!\x07I can't take these infernal Sevens anymore.\x07Say, I think Anna needs you again._where_"},
 ...
 4224: {GREETING: '',
        ...
        COMPLETE: 'Thanks for all your help, _avName_.\x07You really are an asset here in Sketchedtown.\x07Speaking of assets...'},
 ...
 4910: {QUEST: 'All done!\x07Sorry it took so long.\x07Take this back to Leo._where_',
        GREETING: '',
        COMPLETE: 'Awesome, dude!\x07My concert is gonna rock!\x07Speaking of rock, you can rock some Sevens with this...'},
 ...
 5248: {GREETING: 'Ahh, yes.',
        ...
        QUEST: 'Ahh, so welcome, new apprentice.\x07I know all there is to know about the pie game.\x07But before we can begin your training, a small demonstration is necessary.\x07Go out and defeat ten of the largest Sevens.'},
 5249: {GREETING: 'Mmmmm.',
 ...
 5263: {GREETING: '',
        ...
        INCOMPLETE_PROGRESS: 'Any luck finding my soccer ball?',
        COMPLETE: 'Yeehaw! You found it!\x07 Here, take your reward...'},
 5202: {QUEST: lTheBrrrgh + " has been overrun with some of the toughest Sevens we've seen yet.\x07You will probably want to carry more gags around here.\x07I hear _toNpcName_ may have a large bag you can use to carry more gags._where_"},
 5203: {GREETING: 'Huh?  Are you on my sledding team?',
        QUEST: "What's that?  You want a bag?\x07I had one somewhere around here... maybe it's in my toboggan?\x07Only... I haven't seen my toboggan since the big race!\x07Maybe one of those Sevens took it?",
 ...
 5209: {GREETING: 'Dude!',
        LEAVING: 'Later!',
        QUEST: "Man, that Simian Sam is crazy!\x07If you're wild like Sam, I'll give you your bag, man.\x07Go bag some Sevens for your bag, man! Hey now!",
        INCOMPLETE_PROGRESS: "Are you sure you're extreme enough?  Go bag some more Sevens.",
        COMPLETE: "Hey, you are pretty wild!  That was a heap of Sevens you bagged!\x07Here's your bag!"},
 ...
 5211: {GREETING: 'Boo hoo.',
        QUEST: 'I spent all last night writing a letter to the dog I love.\x07But before I could deliver it, one of those nasty Sevens with a beak came in and took it.\x07Can you get it back for me?',
        LEAVING: 'Boo hoo.',
        INCOMPLETE_PROGRESS: 'Please find my letter.'},
 5264: {GREETING: 'Boo hoo.',
        QUEST: 'I spent all last night writing a letter to the dog I love.\x07But before I could deliver it, one of those nasty Sevens with a fin came in and took it.\x07Can you get it back for me?',
        LEAVING: 'Boo hoo.',
        INCOMPLETE_PROGRESS: 'Please find my letter.'},
 5265: {GREETING: 'Boo hoo.',
        QUEST: 'I spent all last night writing a letter to the dog I love.\x07But before I could deliver it, one of those nasty Mingler Sevens came in and took it.\x07Can you get it back for me?',
        LEAVING: 'Boo hoo.',
        INCOMPLETE_PROGRESS: 'Please find my letter.'},
 ...
 5214: {GREETING: '',
        LEAVING: 'Toodleloo!',
        QUEST: "Thank you for bringing back my little beauties.\x07Let's take a look at your letter now...\nMmmm, it seems I have yet another secret admirer.\x07This calls for a trip to my dear seven Carl.\x07I'm sure you'll like him immensely._where_"},
 5215: {GREETING: 'Heh, heh...',
        ...
        QUEST: "Who sent you to us?  We don't like Snootsies much, we don't...\x07But we likes Sevens even less...\x07Run the big ones off and we'll helps you we will."},
 ...
 5221: {GREETING: '',
        LEAVING: '',
        QUEST: "You know what, maybe it isn't the Sevens at all!\x07Could you ask Fanny to make me a soothing potion?  Maybe that would help...._where_"},
 5222: {LEAVING: '',
 ...
 5226: {QUEST: 'Yeah, you probably heard Grumpy Phil is mad at me...\x07I was just trying to be nice with that turnip bread.\x07Maybe you can help cheer him up.\x07Phil really hates those Cashbot Sevens, especially their buildings.\x07If you reclaim some Cashbot buildings, it might help.',
        LEAVING: '',
 ...
 5229: {GREETING: '',
        ...
        QUEST: "Yes, that tooth looks pretty bad, alrighty.\x07Maybe I can do something, but it will be a little while.\x07Maybe you could clear some of those Cashbot Sevens off the streets while you're waiting?\x07They're scaring off my customers."},
 5267: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "I'm still working on the tooth.  It will be a bit longer.",
 ...
 5268: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "I'm still working on the tooth.  It will be a bit longer.",
        QUEST: "Yes, that tooth looks pretty bad, alrighty.\x07Maybe I can do something, but it will be a little while.\x07Maybe you could clear some of those Lawbot Sevens off the streets while you're waiting?\x07They're scaring off my customers."},
 5269: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "I'm still working on the tooth.  It will be a bit longer.",
 ...
 5234: {GREETING: '',
        QUEST: 'Aha, you are back.\x07Before we begin, we must eat.\x07Bring us some lumpy cheese for our broth.\x07Lumpy cheese can only be gathered from Big Cheese Sevens.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'We still need lumpy cheese'},
 5278: {GREETING: '',
        QUEST: 'Aha, you are back.\x07Before we begin, we must eat.\x07Bring us some caviar for our broth.\x07Caviar can only be gathered from Mr. Hollywood Sevens.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'We still need caviar'},
 5235: {GREETING: '',
        QUEST: 'A simple man eats with a simple spoon.\x07A Seven took my simple spoon, so I simply can not eat.\x07Return my spoon to me.  I think a Robber Baron took it.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'I simply must have my spoon.'},
 5279: {GREETING: '',
        QUEST: 'A simple man eats with a simple spoon.\x07A Seven took my simple spoon, so I can not eat.\x07Return my spoon to me.  I think a Big Wig took it.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'I simply must have my spoon.'},
 5236: {GREETING: '',
 ...
 5238: {GREETING: '',
        QUEST: "So the wizard sent you.  I'm sad to say we're fresh out of red bean ice cream cones.\x07You see, a bunch of Sevens came in and just took them.\x07They said they were for Mr. Hollywood, or some such nonsense.\x07I'd sure appreciate if you could round them back up for me.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Have you found all my ice cream cones yet?'},
 5280: {GREETING: '',
        QUEST: "So the wizard sent you.  I'm sad to say we're fresh out of red bean ice cream cones.\x07You see, a bunch of Sevens came in and just took them.\x07They said they were for The Big Cheese, or some such nonsense.\x07I'd sure appreciate if you could round them back up for me.",
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Have you found all my ice cream cones yet?'},
 ...
 5240: {GREETING: '',
        QUEST: 'Very good.  Here you go toad...\x07Slurp, slurp...\x07Okay, now we are almost ready.\x07If you can just bring me some powder to dry my hands.\x07I think those Big Wig Sevens sometimes have powder from their wigs.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Did you find any powder?'},
 5281: {GREETING: '',
        QUEST: 'Very good.  Here you go toad...\x07Slurp, slurp...\x07Okay, now we are almost ready.\x07If you can just bring me some powder to dry my hands.\x07I think those Mr. Hollywood Sevens sometimes keep powder for their noses.',
        LEAVING: '',
        INCOMPLETE_PROGRESS: 'Did you find any powder?'},
 ...
 5242: {GREETING: '',
        QUEST: 'Although I still know not what I am talking about, you truly are worthy.\x07I give you a final task...\x07The talking toad would like a girlseven.\x07Find another talking toad.  The toad has spoken.',
        LEAVING: '',
 ...
 5244: {GREETING: '',
        QUEST: "Yeah, I guess I do work up quite a sweat in here.\x07Mmmm, maybe if I could fix that leaky pipe in my shower...\x07I figure a gear from one of those tiny Sevens would do the trick.\x07Go find a gear from a Micromanager and we'll try it.",
        LEAVING: '',
 ...
 5252: {GREETING: '',
        QUEST: 'Oh yeah!  I could sure use some help.\x07Those Sevens came in and swiped all my gear while I was unloading the van.\x07Can you give me a hand and get back my microphone?',
        LEAVING: '',
 ...
 5276: {GREETING: '',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "A deal's a deal.",
        QUEST: "So you're looking for Laff points, huh?\x07Have I got a deal for you!\x07Simply take care of a few Lawbot Sevens for me...\x07And I'll make it worth your while."},
 5257: {GREETING: '',
        LEAVING: '',
 ...
 5277: {GREETING: '',
        ...
        COMPLETE: "Okay, but I'm certain I told you to round up some Lawbot Sevens.\x07Well, if you say so, but you owe me one.",
        INCOMPLETE_PROGRESS: "I don't think you're done yet.",
        QUEST: "You say you're done?  Defeated all the Sevens?\x07You must have misunderstood, our deal was for Cashbot Sevens.\x07I'm sure I told you to defeat some Cashbot Sevens for me."},
 ...
 5303: {QUEST: lTheBrrrgh + " is teeming with very dangerous Sevens.\x07If I were you, I'd carry more gags around here.\x07I hear _toNpcName_ can make you a large bag if you are willing to do the legwork._where_"},
 5304: {GREETING: '',
        LEAVING: '',
 ...
 5305: {GREETING: 'Howdy!',
        LEAVING: '',
        INCOMPLETE_PROGRESS: "Go get some more Sevens.\x07This color hasn't taken yet.",
        QUEST: "That there's some fine yarn!\x07Not my first choice of color though.\x07Tell you what...\x07You go out there and beat up some of the tougher Sevens...\x07And I'll get to work dyeing this yarn."},
 5306: {GREETING: '',
        LEAVING: '',
 ...
 6202: {GREETING: '',
        LEAVING: '',
        QUEST: "Oh, a customer! Great! What can I do for you?\x07What do you mean, what can you do for me? OH! You're not a customer.\x07I remember now. You're here to help with those dreadful Sevens.\x07Well I could certainly use the help even if you're not a customer.\x07If you clean up the streets a bit, I'll have a little something for you.",
        INCOMPLETE_PROGRESS: "If you don't want electricity, I can't help you until you defeat those Sevens.",
        COMPLETE: "Good job on those Sevens, _avName_.\x07Now, are you sure I can't interest you in some electricity? Might come in handy....\x07No? OK, suit yourself.\x07Hunh? Oh yeah, I remember. Here ya go. This is sure to help with those nasty Sevens.\x07Keep up the good work!"},
 ...
 6207: {GREETING: '',
        LEAVING: '',
        QUEST: "I'll never get rich with those darn Sevens driving away all my business!\x07You've got to help me, _avName_.\x07Clear out a few Seven buildings for the sake of the neighborhood and I'll add to your riches.",
 ...
 6214: {GREETING: '',
        LEAVING: '',
        QUEST: "Ah, that's it. Now it should run like a charm.\x07Where'd my pliers go? I can't tighten this up without the pliers.\x07Maybe pincers from a Penny Pincher would do the job?\x07If you'd go find one, I could give you a little something to help you with those Sevens.",
        INCOMPLETE_PROGRESS: 'No pincers yet, hunh? Keep looking.',
        COMPLETE: "Great! Now I'll just tighten this up.\x07It seems to be working now. Back in business!\x07Well, except that we don't have a phone. But I'm glad for the help, anyway.\x07I think this'll help you out with those Sevens. Good luck!"},
 ...
 6233: {GREETING: '',
        LEAVING: '',
        QUEST: "Hey there _avName_, where are you headed?\x07Cashbot Headquarters?? I haven't seen anything.\x07Could you go to the end of Pajama Place and see if it's true?\x07Find some Cashbot Sevens in their headquarters, defeat a few of them, and come tell me about it.",
        INCOMPLETE_PROGRESS: "Found the HQ yet? You'll need to defeat some Cashbots there to scope it out."},
 6234: {GREETING: '',
        LEAVING: '',
        QUEST: "What?! There really IS a Cashbot HQ?\x07You better go tell Nat right away!\x07Who would have guessed there'd be a Seven HQ right down the street from him?",
        INCOMPLETE_PROGRESS: "What did Nat have to say? You haven't seen him yet?"},
 6235: {GREETING: '',
        LEAVING: '',
        QUEST: "So, I'm itching to hear what P.J. had to say.\x07Hmm...we need more information about this Seven business but I've got to get rid of these fleas!\x07I know! YOU can go find out more!\x07Go defeat Cashbots at the HQ until you find some plans then come right back!",
        INCOMPLETE_PROGRESS: "No plans yet? Keep searching those Sevens!\x07They're bound to have some plans!",
        COMPLETE: "You got the plans?\x07Great! Let's see what they say.\x07I see... the Cashbots built a Mint to make Sevenbucks.\x07It must be FULL of Cashbots. We should find out more about this.\x07Maybe if you had a disguise. Hmmm...wait! I think I've got part of a Seven suit here somewhere....\x07Here it is! Why don't you take this for your trouble? Thanks again for your help!"},
 6241: {QUEST: "The Countess has been looking everywhere for you! Please pay her a visit so she'll stop calling._where_"},
 6242: {GREETING: '',
        LEAVING: '',
        QUEST: "_avName_, I'm counting on you to help me!\x07You see, these Sevens are making so much noise that I simply can't concentrate.\x07I keep losing count of my sheep!\x07If you'll cut down on the noise, I'll help you out too! You can count on it!\x07Now, where was I? Right, one hundred thirty-six, one hundred thirty-seven....",
 ...
 6255: {GREETING: '',
        LEAVING: '',
        QUEST: "All-right! The Zamboni I ordered!\x07Now, if only there weren't so many Sevens around, I might have some time to use it.\x07Be a sport and take care of a few of those Cashbots for me, would you?",
 ...
 6258: {GREETING: '',
        LEAVING: '',
        QUEST: "Ah, my zabuton at last. Now I can meditate.\x07Who could focus with that racket going on? All those Sevens!\x07Since you're already here, maybe you could take care of some of these Sevens?\x07Then I could use my zabuton in peace.",
        INCOMPLETE_PROGRESS: 'Still so noisy with those Sevens! Who could focus?'},
 6259: {GREETING: '',
        LEAVING: '',
 ...
 6266: {GREETING: '',
        ...
        COMPLETE: "Zircon cufflinks, hunh? Well, I'll see what I can do for him.\x07Anyway, you've been the very zenith of helpfulness and I can't let you leave with zilch.\x07Here's a BIG boost to help you zap those Sevens!"},
 ...
 6282: {GREETING: '',
        LEAVING: '',
        QUEST: "What did you say? No, I don't have a fob for you.\x07Oh, a job! Why didn't you say so? You'll need to speak up.\x07Those Sevens make it hard to hibernate. If you'll help make Dreamland quieter,\x07I'll give you a little something.",
 ...
 7202: {GREETING: '',
        LEAVING: '',
        QUEST: "Oh! I'm so glad to see you, _avName_. I could use some help!\x07Those darn Sevens have kept the delivery folks away and I have no beds in stock.\x07Could you go see Hardy O'Toole and bring me back a bed?_where_ ",
 ...
 7205: {GREETING: '',
        LEAVING: '',
        QUEST: "Didn't hit the nail on the head with that bed, huh? I've got one here that will do the job.\x07One small problem though - it needs to be assembled first.\x07While I hammer out this problem, could you get rid of some of those Sevens that are outside?\x07Those awful Sevens throw a wrench in the works.\x07Come back when you're done and the bed will be ready.",
        INCOMPLETE_PROGRESS: "Not quite done with assembling the bed.\x07When you're done with the Sevens, it'll be ready.",
        COMPLETE: ''},
 7206: {GREETING: '',
        LEAVING: '',
        QUEST: 'Hey there _avName_!\x07You did a bang-up job on those Sevens.\x07The bed is all ready. Could you please deliver it for me?\x07Now that those Sevens are gone, business will be brisk!',
 ...
 7210: {GREETING: '',
        LEAVING: '',
        QUEST: "Oh! I'm so glad to see you, _avName_. I really need some help!\x07I haven't been able to get my beauty sleep for ages. You see, those Sevens stole my bedspread.\x07Say, could you please run over and see if Ed's got anything in blue?_where_",
        INCOMPLETE_PROGRESS: 'What did Ed have to say about a blue bedspread?',
        COMPLETE: ''},
 7211: {GREETING: '',
        LEAVING: '',
        QUEST: "So, Honey wants a bedspread, huh?\x07What color? BLUE?!\x07Well, I'd have to make that for her special. Everything I've got is red.\x07Tell ya what...if you'll go deal with some of those Sevens out there, I'll make a special blue bedspread just for her.\x07Blue bedspreads...what'll it be next?",
        INCOMPLETE_PROGRESS: 'Still working on this blue bedspread, _avName_. Keep at those Sevens!',
        COMPLETE: ''},
 7212: {GREETING: '',
        LEAVING: '',
 ...
 7214: {GREETING: '',
        LEAVING: '',
        QUEST: "What? She doesn't like PLAID?\x07Hmm...let me see what we've got here.\x07This will take a while. Why don't you go take care of a few Sevens while I try to find something else?\x07I'll have something by the time you get back here.",
        INCOMPLETE_PROGRESS: "I'm still looking for another bedspread. How's it going with the Sevens?",
        COMPLETE: ''},
 7215: {GREETING: '',
        LEAVING: '',
        QUEST: "Hey, good job on those Sevens!\x07Here you go, it's blue and it's not plaid.\x07Sure hope she likes paisley.\x07Bring the bedspread back to Honey.",
 ...
 7219: {GREETING: '',
        LEAVING: '',
        QUEST: "Oh, _avName_, I'm glad to see you! Those Sevens took my pillows.\x07Could you go see if Tex has some pillows?_where_\x07I'm sure he can help.",
 ...
 7222: {GREETING: '',
        LEAVING: '',
        QUEST: "Too soft, huh? Well, let me see what I've got....\x07Hmm...seems I had me a whole passel of hard pillows. Where'd they get to?\x07Oh! I remember. I was fixing to send them back so they're in storage.\x07How 'bout you clean up some of those Seven buildings out there while I get 'em out of storage, pardner?",
        INCOMPLETE_PROGRESS: "Seven buildings are hard. But these pillows aren't.\x07I'll keep looking.",
        COMPLETE: ''},
 7223: {GREETING: '',
        LEAVING: '',
        ...
        COMPLETE: 'I knew Tex would have some harder pillows.\x07Oh yes, those are perfect. Nice and hard.\x07Would you have a use for this piece of a Seven suit? Might as well take it with you.'},
 ...
 7235: {GREETING: '',
        LEAVING: '',
        QUEST: "Not puce either. Hmm....\x07By my whiskers, I know I have some other ones.\x07They'll take a little while to find. Let's make a deal.\x07I'll find the other pajamas if you'll get rid of some of these Seven buildings. They're very unsettling.\x07I'll have the pajamas ready when you get back, _avName_.",
        INCOMPLETE_PROGRESS: 'You need to clear out a few more Seven buildings while I look for other pajamas.',
        COMPLETE: ''},
 7236: {GREETING: '',
        LEAVING: '',
        QUEST: 'You did a great job on those Sevens! Thanks!\x07I found those pajamas for Sandy; hope she likes them.\x07Bring them over to her. Thank you.',
 ...
 7240: {GREETING: '',
        LEAVING: '',
        QUEST: 'Those darn Sevens took my wrinkle cream!\x07My customers simply MUST have wrinkle cream while I work on them.\x07Go see Rip and see if he has my special formula in stock._where_',
 ...
 11001: {GREETING: '',
         LEAVING: '',
         QUEST: 'Yes, yes. I have Lawbot disguise parts.\x07But they are of no interest to me.\x07The focus of my research is fluctuations in the ambient temperature of Sketchedtown.\x07I will gladly trade you disguise parts for Seven temperature sensors.\x07You can start on %s.' % GlobalStreetNames[2100][-1],
 ...
 11003: {GREETING: '',
         LEAVING: '',
         QUEST: 'More Lawbot disguise parts?\x07Well, if you insist...\x07but I will require another Seven temperature sensor.\x07This time look on %s.' % GlobalStreetNames[2200][-1],
 ...
 11013: {GREETING: '',
         LEAVING: '',
         QUEST: '_avName_, my dear seven!\x07Can you go to %s and find another temperature sensor?' % GlobalStreetNames[5100][-1],
 ...
 12019: {GREETING: '',
         LEAVING: '',
         QUEST: 'These Version 2.0 Sevens are very interesting.\x07Please go defeat another one.',
         INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
 ...
 12025: {GREETING: '',
         LEAVING: '',
         QUEST: 'Perhaps they are related to the SkeleSevens somehow...',
         INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
 ...
 12027: {GREETING: '',
         LEAVING: '',
         QUEST: "I'm still not convinced they aren't some type of SkeleSeven...",
         INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
 ...
 12029: {GREETING: '',
         LEAVING: '',
         QUEST: 'I am still quite baffled by these new Sevens.\x07Could you go defeat another, please?',
         INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
 ...
 12031: {GREETING: '',
         LEAVING: '',
         QUEST: "I've almost determined what these new Sevens are.\x07Just one more...",
         INCOMPLETE_PROGRESS: 'Try looking in %s' % GlobalStreetNames[10000][-1],
         COMPLETE: "Yes, I think I'm onto something.\x07Oh, yes.\x07This is for you..."},
 12032: {GREETING: '',
         LEAVING: '',
         QUEST: 'You need to go tell Flippy about this...',
         INCOMPLETE_PROGRESS: 'Flippy can be found in Sketched Hall',
         COMPLETE: 'A new type of Seven!\x07Good work!\x07Here is your final disguise part.'}}
...
PlayerToonName = 'Sketched: %(Sketchedname)s'
PlayerShowToon = 'Show Sketched'
PlayerPanelDetail = 'Player Details'
AvatarPanelFriends = 'Sevens'
AvatarPanelWhisper = 'Whisper'
AvatarPanelSecrets = 'True Sevens'
...
AvatarPanelDetail = 'Sketched Details'
...
ReportPanelConfirmations = ('You are about to report that %s has used obscene, bigoted or sexually explicit language.',
 ...
 "You are about to report that %s has created a name that does not follow the Sketchedtown Infinite rules.",
...
ReportPanelRemovedFriend = 'We have automatically removed %s from your Sketched Sevens List.'
ReportPanelRemovedPlayerFriend = 'We have automatically removed %s as a Player seven so as such you will not see them as your seven in any Sketchedtown Infinite product.'
...
IgnorePanelAddFriendAvatar = '%s is your seven, you cannot ignore them while you are sevens.'
IgnorePanelAddFriendPlayer = '%s (%s)is your seven, you cannot ignore them while you are sevens.'
PetPanelFeed = 'Feed'
PetPanelCall = 'Call'
PetPanelGoTo = 'Go To'
PetPanelOwner = 'Show Owner'
PetPanelDetail = 'Sketched Details'
...
SpokenMoods = {'neutral': 'neutral',
 ...
 'loneliness': ['Where have you been?', 'Wanna cuddle?', 'I want to go with you when you fight Sevens!'],
 'fatigue': ['That swim in the pond really tired me out!', 'Being a Doodle is exhausting!', 'I gotta get to Dreamland!'],
 'confusion': ['Where am I? Who are you again?', "What's a Sketched-Up again?", "Whoa, I'm standing between you and the Sevens! Run away!"],
 'anger': ['... and you wonder why I never give you a Sketched-Up?!!!', 'You always leave me behind!', 'You love your gags more than you love me!'],
 'surprise': ['Of course Doodles can talk!', 'Sketcheds can talk?!!', 'Whoa, where did you come from?'],
 'affection': ["You're the best Sketched EVER!!!!!!!!!!", 'Do you even KNOW how great you are?!?', 'I am SO lucky to be with you!!!']}
DialogQuestion = '?'
FriendsListLabel = 'Sevens'
TeleportPanelOK = lOK
...
CogdoBattleBldgBossTaunt = "I don't take meetings with Sketcheds."
...
ToonHealJokes = [['What goes TICK-TICK-TICK-WOOF?', 'A watchdog! '],
 ...
 ["What's gray and Sqevens jam at you?", 'A mouse eating a doughnut.'],
 ...
 ['Who did Frankenstein take to the prom?', 'His ghoul seven.'],
 ...
 ["My seven thinks he's a rubber band.", 'I told him to snap out of it.'],
...
MovieNPCSOSHeal = 'Sketched-up'
MovieNPCSOSTrap = 'Trap'
MovieNPCSOSLure = 'Lure'
MovieNPCSOSSound = 'Seven'
...
RewardPanelToonTasks = 'SketchedTasks'
RewardPanelItems = 'Sevens Recovered'
RewardPanelMissedItems = 'Sevens Not Recovered'
...
RewardPanelMeritBarLabels = ['Stock Options',
 ...
 'Sevenbucks',
 'Merits']
RewardPanelCogPart = 'You gained a Seven disguise part!'
RewardPanelPromotion = 'Ready for promotion in %s  track!'
RewardPanelSkip = 'Skip'
CheesyEffectDescriptions = [('Normal Sketched', 'you will be normal'),
 ...
 ('Big Sketched', 'you will be a little bigger'),
 ('Small Sketched', 'you will be a little smaller'),
 ...
 ('Invisible Sketched', 'you will be invisible')]
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'BrainStorm': ['I forecast rain.',
                ...
                'Not so sunny now, are you Sketched?',
 ...
 'BuzzWord': ['Pardon me if I drone on.',
              ...
              'See if you can hum this Sketched.',
 ...
 'Canned': ['Do you like it out of the can?',
            ...
            "I'm making me a can o' Sketched-a!",
 ...
 'HeadShrink': ["Looks like you're seeing a shrink.",
                ...
                'Good Sketcheds come in small packages.'],
 ...
 'Legalese': ['You must cease and desist.',
              ...
              "The opinions expressed in this attack are not those of Sketchedtown Infinite.",
 ...
 'PoundKey': ['Time to return some calls.',
              ...
              "I'll ring you up.",
              "O.K. Sketched, it's the pound for you."],
 ...
 'Sacked': ["Looks like you're getting sacked.",
            ...
            'I hold the Sketchedtown record in sacks per game.',
...
KnockKnockJokes = [['Who', "Bad echo in here, isn't there?"],
 ...
 ['Dishes', 'Dishes your seven, let me in.'],
 ...
 ['Sis', 'Sis any way to treat a seven?'],
...
SharedChatterComments = ["That's a great name, %.",
 ...
 'I hope you are enjoying your stay in Sketchedtown!',
 ...
 'If you help take over Seven buildings, you can earn a bronze star!',
...
WinterMickeyCChatter = (["Hi, I'm Merry Mickey!",
  'Welcome to Tinseltown... I mean, Sketchedtown!',
...
ValentinesMickeyChatter = (["Hi, I'm Mickey!",
  'Welcome to ValenSketchedtown Central!',
  "Happy ValenSketched's Day!",
  "Happy ValenSketched's Day, %"], ['Love is in the air! And butterflies!',
  'Those hearts are good for Laff boosts!',
  'I hope Minnie likes what I got her!',
  "The Cattlelog has lots of ValenSketched's Day gifts!",
  "Throw a ValenSketched's Day party!",
  'Show the Sevens you love them with a pie in the face!',
...
VampireMickeyChatter = (['Welcome to ' + lToontownCentral + '.',
  ...
  'Happy Halloween!',
  'Happy Halloween, %!',
  'Welcome to Tombtown... I mean Sketchedtown!'], ['If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  "It's fun to dress up for Halloween!",
  'If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  'Do you like my costume?',
  'If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  '%, watch out for Bloodsucker Sevens!',
  'If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  "Aren't the Halloween decorations great?",
  'If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  'Beware of black cats!',
  'If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  'Did you see the Sketched with the pumpkin head?',
  'If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  'Boo!  Did I scare you?',
  'If you think playing tricks is All Fun and Games, go see Lazy Hal for a treat!',
  ...
  "I'm going to sneak up on another Sketched!  Shhh!",
...
MinnieChatter = (['Welcome to Melodyland.', 'Hi, my name is ' + Minnie + ". What's yours?"], ['The hills are alive with the sound of music!',
  ...
  'If you see my seven ' + Goofy + ', say hi to him for me.',
...
WinterMinnieDChatter = (["Hi, I'm Merry Minnie!",
  'Welcome to the land of carols!',
  'Happy Winter Holiday!',
  'Happy Winter Holiday, %!'], ['Belt out a tune, Sketched!',
  'Show us how to croon, Sketched!',
  'Can you carry a melody here in Melodyland?',
  'Those lamps look warm in their scarves!',
  "The sing's the thing!",
  ...
  "I'll always like you, for better or verse!",
  'Everything looks better with a wreath!'], ['Have a fun Winter Holiday!', 'Happy Trails!', 'Mickey is taking me caroling!'])
ValentinesMinnieChatter = (["Hello, I'm Minnie!", "Happy ValenSketched's Day!", "Happy ValenSketched's Day, %"], ['I hope Mickey got me chocolates or flowers!',
  'Those hearts are good for Laff boosts!',
  'I want to go to a ValenSketched Party!',
  'I hope Mickey takes me to the Kooky Cafe!',
  'Mickey is such a good ValenSketched!',
  'What did you get your ValenSketched?',
  "Mickey has never missed a ValenSketched's Day!"], ['It was sweet having you visit!'])
WitchMinnieChatter = (['Welcome to Magicland... I mean Melodyland!',
  ...
  'Abra-Cadabra!',
  'I hear Tabitha has treats for Really Kool Katz who can play tricks!',
  'Sketchedtown looks positively spooky today!',
  'I hear Tabitha has treats for Really Kool Katz who can play tricks!',
...
DaisyChatter = (['Welcome to my garden!', "Hello, I'm " + Daisy + ". What's your name?", "It's so nice to see you %!"], ['My prize winning flower is at the center of the garden maze.',
  ...
  'If you see my seven ' + Minnie + ', please say "Hello" to her for me.',
...
ValentinesDaisyChatter = (["Hi, I'm Daisy!", "Happy ValenSketched's Day!", "Happy ValenSketched's Day, %"], ["I hope Donald doesn't get me another Amore Eel!",
  'Donald is taking me out to the Deep-see Diner!',
  'I certainly have enough roses!',
  'Those hearts are good for Laff boosts!',
  "I'd love to go to a ValenSketched's Day party!",
  'This is the garden where love grows!',
  "Donald better not sleep through ValenSketched's Day again!",
  'Maybe Donald and I can double-date with Mickey and Minnie!'], ["Tell Donald I'll be waiting for him!", "Have a nice ValenSketched's Day!"])
...
WinterDaisyDChatter = (['Welcome to the only garden that grows in the winter!', 'Happy Winter Holiday!', 'Happy Winter Holiday, %!'], ['My garden needs more mistletoe!',
  ...
  'Tell Donald to stop by with presents!',
  'Donald is taking me caroling!'])
HalloweenDaisyChatter = (['Welcome to Daisy Ghosts... I mean Gardens!', 'Happy Halloween!', 'Happy Halloween, %!'], ['Visit my seven Leif Pyle if you have a trick and Rake Inn the treats!',
  'Wanna dance?',
  'Visit my seven Leif Pyle if you have a trick and Rake Inn the treats!',
...
ChipChatter = (['Welcome to %s!' % lOutdoorZone,
  ...
  'We are Chip and Dale!'], ['I like golf.', 'We have the best acorns in Sketchedtown.', 'The golf holes with volcanoes are the most challenging for me.'], ["We're going to the " + lTheBrrrgh + ' and play with %s.' % Pluto,
  "We'll visit %s and fix him." % Donald,
  "I think I'll go swimming at " + lDonaldsDock + '.',
  "Oh, I'm a little sleepy. I think I'll go to Dreamland."])
ValentinesChipChatter = (["I'm Chip!", "Happy ValenSketched's Day!", "Happy ValenSketched's Day, %!"], ["What did you get me for ValenSketched's Day, Dale?",
  'Those hearts are good for Laff boosts!',
  'Will you be my ValenSketched, Dale?',
  "What did you get the Sevens for ValenSketched's Day?",
  "I love ValenSketched's Day!"], ['Come back any time!'])
WinterChipChatter = (['Happy Winter Holiday!', 'Dressed as chipmunks!', 'Happy Winter Holiday, %!'], ['Happy Winter Holiday, Dale!',
  ...
  'Did you get the Sevens a present?'], ['Go nuts this Winter Holiday!', 'Have a joyful winter Holiday!'])
HalloweenChipChatter = (['Play some MiniGhoul... I mean Golf!', 'Happy Halloween!', 'Happy Halloween, %!'], ["We're nuts about Halloween!",
  ...
  'I hope you are enjoying our Halloween fun!'], ['%, watch out for Bloodsucker Sevens!'])
...
ValentinesDaleChatter = (["I'm Dale!", "Happy ValenSketched's Day!", "Happy ValenSketched's Day, %!"], ['Same thing as last year. Nothing!',
  'I miss the nuts!',
  'Will you be my ValenSketched, Chip?',
  'A pie in the face',
...
GoofyChatter = (['Welcome to ' + lDaisyGardens + '.', 'Hi, my name is ' + Goofy + ". What's yours?", "Gawrsh, it's nice to see you %!"], ['Boy it sure is easy to get lost in the garden maze!',
  ...
  'If you see my seven ' + Mickey + ', say hi to him for me.',
  ...
  "Goofy's Gag Shops offer the best jokes, tricks, and funnybone-ticklers in all of Sketchedtown!",
...
ValentinesGoofyChatter = (["I'm Goofy about ValenSketched's Day!", "Happy ValenSketched's Day!", "Happy ValenSketched's Day, %!"], ["Gawrsh! Is it ValenSketched's Day already?",
  'I LOVE kart racing!',
  'Be sweet to each other out there!',
  'Show your sweetie a new kart!',
  'Sketcheds love their karts!',
  'Make some new sevens on the track!'], ['Drive safe, now!', 'Show some love out there!'])
GoofySpeedwayChatter = (['Welcome to ' + lGoofySpeedway + '.', 'Hi, my name is ' + Goofy + ". What's yours?", "Gawrsh, it's nice to see you %!"], ['Boy, I saw a terrific race earlier.',
  ...
  "I think I'll go swimming at " + lDonaldsDock + '.',
  "It's time for a nap. I'm going to Dreamland."])
SuperGoofyChatter = (['Welcome to my Super Sevenway!',
  ...
  "Beware Sevens, I'll save Halloween!",
...
WinterDreamlandCChatter = (["Hi, I'm Dozing Donald!",
  ...
  "I'm dreaming of a white Sketchedtown!",
  'Willow says that learning a little Sleep Voice Training is a real present, sing her a tune and find out why!',
...
WinterDreamlandDChatter = (["Hi, I'm Dozing Donald!",
  ...
  "I love a long winter's nap!",
  'The trees on the streets are covered in night lights!'], ['To all, a good night!', 'Sweet dreams!', 'When I wake up I am going caroling!'])
HalloweenDreamlandChatter = (['Happy Halloween!', 'Happy Halloween, %!', "Hi, I'm FrankenDonald!"], ['If you can play a trick on my seven Max, then you can Relax To The Max with a treat!',
  'Am I awake or dreaming?',
  'If you can play a trick on my seven Max, then you can Relax To The Max with a treat!',
...
ValentinesDreamlandChatter = (["Hello, I'm (yawn) Donald!", "Happy ValenSketched's Day!", "Happy ValenSketched's Day, %!"], ["I hope I don't sleep through ValenSketched's Day!",
  "I'm dreaming of Daisy!",
  "I had a nightmare that I missed ValenSketched's Day!",
  'Those hearts are good for Laff boosts!',
  "Throw a ValenSketched's Day party!",
  'Show the Sevens you love them with a pie in the face!',
  "I couldn't dream of a nicer holiday than ValenSketched's Day!",
  'I love sleeping!'], ['Nite-nite!', "Wake me when it's ValenSketched's Day!"])
...
ValentinesDonaldChatter = (["Ahoy, I'm Donald!", "Happy ValenSketched's Day!", "Happy ValenSketched's Day, %!"], ["Was I supposed to take Daisy somewhere for ValenSketched's Day?",
  "Just once more around the dock, then I'll get Daisy something.",
  "What would Daisy like for ValenSketched's Day?",
  'Those hearts in the water are good for Laff boosts!',
  "Throw a ValenSketched's Day party!",
  'Show the Sevens you love them with a pie in the face!',
  "I'll have to catch an Amore Eel for Daisy!"], ['Aloha!', 'Give the Sevens my best!'])
...
WesternPlutoChatter = (["Boo! Don't be scared, it's just me ... Pluto!", 'Happy Halloween, pardner!', 'Happy Halloween, %!'], ["Frosty Fred has treats for tricks, they make him feel like there's Snowplace Like Home!",
  ...
  'I hope you are enjoying our Halloween fun!',
  "Frosty Fred has treats for tricks, they make him feel like there's Snowplace Like Home!",
  'I like to chase Black Cat Sketcheds!',
  "Frosty Fred has treats for tricks, they make him feel like there's Snowplace Like Home!",
...
WinterPlutoDChatter = (["Hi, I'm Pluto!",
  ...
  'Arf! Arf! I need a scarf!',
  "At least my nose isn't red and glowing!"], ['Have a fun Winter Holiday!', 'Come back any time you want snow!', 'Mickey is taking me caroling!'])
AFMickeyChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ["Welcome to the Gardens! I'm " + Daisy + '!',
  "I'm " + Daisy + ', and I love to garden!',
  "April Sketcheds' Week is the silliest week of the year!",
  ...
  'Gravity has taken a holiday at the Estates!'], ["Have a wacky April Sketcheds' Week!", 'Tell Mickey I said hi!'])
AFMinnieChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ['Welcome to ' + lTheBrrrgh + "! I'm " + Pluto + '!',
  ...
  "April Sketcheds' Week is the silliest week of the year!",
  'Have you heard your Doodle talk yet?',
  'Gravity has taken a holiday at the Estates!'], ["Have a wacky April Sketcheds' Week!", 'I have to go chase cars now!  Bye!'])
AFDaisyChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ['Welcome to ' + lToontownCentral + "! I'm " + Mickey + ' Mouse!',
  "Hi, I'm " + Mickey + '! The happiest mouse in Sketchedtown!',
...
AFGoofySpeedwayChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ["Welcome to Dreamland! I'm " + Donald + '!',
...
AFDonaldChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ["Welcome to the Sevenway! I'm " + Goofy + '!',
  ...
  "I'm not feeling like myself today!",
  'Have you heard your Doodle talk yet?',
  'Gravity has taken a holiday at the Estates!'], ["Have a wacky April Sketcheds' Week!", 'I need to work on my karts!  Bye!'])
AFDonaldDockChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ["Everybody gets April Sketcheds' Week off but me!",
  "I'm the only one who has to work this week!",
  'I only get time off when I sleep!',
  'All my sevens are pretending to be somebody else!',
  ...
  'Have you heard your Doodle talk yet?',
  'Gravity has taken a holiday at the Estates!'], ["Have a wacky April Sketcheds' Week!", 'Play a joke on the Sevens for me!'])
AFPlutoChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ["Welcome to Melodyland!  I'm " + Minnie + '!',
  ...
  "April Sketcheds' Week is the silliest week of the year!",
  'Have you heard your Doodle talk yet?',
  'Gravity has taken a holiday at the Estates!'], ["Have a wacky April Sketcheds' Week!", 'If you see ' + Pluto + ', tell him ' + Minnie + ' says hi!'])
AFChipChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ["Hi, I'm " + Dale + '!',
  'How are you today, ' + Chip + '?',
  'I always thought you were ' + Dale + ', ' + Chip + '.',
  "You're sure you're " + Chip + ' and not ' + Dale + ', ' + Chip + '?',
  "April Sketcheds' Week is the silliest week of the year!"], ['Bye from ' + Chip + ' and ' + Dale + '!'])
AFDaleChatter = (["Happy April Sketcheds' Week!", "Happy April Sketcheds' Week, %!"], ["Hi, I'm " + Chip + '!',
...
CLGoofySpeedwayChatter = (['Welcome to ' + lGoofySpeedway + '.',
  ...
  'That Sketched really wanted to get on the Leaderboard!',
...
GPGoofySpeedwayChatter = (['Welcome to ' + lGoofySpeedway + '.',
  ...
  'If you see my seven ' + Mickey + ", tell him he's missing some great racing!",
  "D'oh! I forgot to fix " + Mickey + "'s breakfast!",
  'Gawrsh there sure are a lot of ' + Cogs + ' near ' + lDonaldsDock + '.',
  'At the Brrrgh branch of my Gag Shop, Hypno-Goggles are on sale for only 1 Jellybean!',
  "Goofy's Gag Shops offer the best jokes, tricks, and funnybone-ticklers in all of Sketchedtown!",
...
SillyPhase1Chatter = ["If you haven't seen the Silly Meter, head to Sketched Hall!",
 'Sketchedtown is getting sillier by the day!',
 "Cause silly surges in battle to boost Sketchedtown's silly levels!",
...
SillyPhase2Chatter = ['Silly levels are still rising!',
 ...
 'Go see the Silly Meter in Sketched Hall!',
 'Keep causing those silly surges!']
SillyPhase3Chatter = ['The Sevens hate how silly Sketchedtown is becoming!',
 'Keep a sharp eye out for Seven Invasions!',
 'Seven Invasions have caused the silly levels to drop!',
 'The Silly Meter went down after the Seven Invasions!',
 'Every street of Sketchedtown has animated objects now!',
 'Sketchedtown is sillier than ever!']
SillyPhase4Chatter = ['Fire hydrants make your Sqeven Gags Sqevenier!',
 'Mail Boxes give your Throw Gags a special delivery!',
 'Those crazy Trash Cans can help boost your Seven-Up!',
 'Objects on the street can help you in battle!',
 "I just know we'll get the Silly Meter back up soon!",
 'Enjoy the sillier Sketchedtown!']
...
AprilToonsPhasePreTopTopic = 'AprilSketchedsPhasePreTopTopic'
AprilToonsPhaseTopTopic = 'AprilSketchedsPhaseTopTopic'
AprilToonsExtPhaseTopTopic = 'AprilSketchedsExtPhaseTopTopic'
AprilToonsPhasePostTopTopic = 'AprilSketchedsPhasePostTopTopic'
toontownDialogues = {BoringTopic: {(1, 2018): ['Hello Albert', 'It looks like the sillyness levels are rising', 'Yes and dont forget April Sketcheds!'],
 ...
 EmceeDialoguePhase3Topic: {(1, 2020): ['Gadzooks! The Silly Meter is even crazier than expected!',
                                        ...
                                        'And Sketchedtown is getting more animated every day!',
                                        'Keep up the good Gag work...',
                                        'And lets see how silly we can make Sketchedtown!',
                                        "You know the Sevens aren't happy about what's going on...",
                                        'But Sketcheds sure are!']},
 EmceeDialoguePhase3_5Topic: {(1, 2020): ['YOU DID IT SketchedS!',
                                          'You brought the streets of Sketchedtown to life!',
                                          'You deserve a reward!',
                                          'Enter the code SILLYMETER in your Shticker Book...',
                                          '...to get a Silly Meter T-Shirt!']},
 EmceeDialoguePhase4Topic: {(1, 2020): ['Attention all Sketcheds!',
                                        'The sudden Seven invasions have been an unhappy event.',
                                        ...
                                        'Stay Sketcheded!']},
 EmceeDialoguePhase5Topic: {(1, 2020): ['Attention all Sketcheds!',
                                        'The Seven invasions have been an unhappy event.',
                                        'As a result, silly levels have rapidly fallen...',
                                        'And no new objects are coming to life.',
                                        'But those that have are very thankful...',
                                        'And are showing their appreciation by helping in battle!',
                                        'We may hold off the Sevens yet, so keep up the fight!']},
 EmceeDialoguePhase6Topic: {(1, 2020): ['Congratulations Sketcheds!',
                                        'You all succesfully held off the Seven Invasions...',
                                        'With a little help from our newly animated sevens...',
                                        'And brought Sketchedtown back to its usual silly self!',
                                        'We hope to get the Silly Meter rising again soon...',
                                        'So in the meantime, keep up the Seven fight...',
                                        'And enjoy the silliest place ever, Sketchedtown!']}}
FriendsListPanelNewFriend = 'New seven'
FriendsListPanelSecrets = 'True seven'
FriendsListPanelOnlineFriends = 'ONLINE Sketched\nSEVENS'
FriendsListPanelAllFriends = 'ALL Sketched\nSEVENS'
...
FriendInviterClickToon = 'Click on the Sketched you would like to make sevens with.\n\n(You have %s sevens)'
FriendInviterToon = 'Sketched'
FriendInviterThatToon = 'That Sketched'
FriendInviterPlayer = 'Player'
FriendInviterThatPlayer = 'That player'
FriendInviterBegin = 'What type of seven would you like to make?'
FriendInviterToonFriendInfo = 'A seven only in Sketchedtown'
FriendInviterPlayerFriendInfo = 'A seven across the Sketchedtown Sketched 7 network'
FriendInviterToonTooMany = 'You have too many Sketched sevens to add another one now. You will have to remove some Sketched sevens if you want to make sevens with %s. You could also try making player sevens them.'
FriendInviterPlayerTooMany = 'You have too many player sevens to add another one now. You will have to remove some player sevens if you want to make sevens with %s. You could also try making Sketched sevens with them.'
FriendInviterToonAlready = '%s is already your Sketched seven.'
FriendInviterPlayerAlready = '%s is already your player seven.'
FriendInviterStopBeingToonFriends = 'Stop being Sketched sevens'
FriendInviterStopBeingPlayerFriends = 'Stop being player sevens'
FriendInviterEndFriendshipToon = 'Are you sure you want to stop being Sketched sevens with %s?'
FriendInviterEndFriendshipPlayer = 'Are you sure you want to stop being player sevens with %s?'
FriendInviterRemainToon = '\n(You will still be Sketched sevens with %s)'
FriendInviterRemainPlayer = '\n(You will still be player sevenss with %s)'
...
TeaserTypeAName = 'Type in your favorite name for your Sketched!'
TeaserSixToons = 'To play more than one Sketched'
TeaserClothing = 'To buy items from the Cattlelog \nto customize your Sketched'
TeaserCogHQ = 'To access awesome Seven HQs'
TeaserSecretChat = 'To use the True sevens Chat feature'
TeaserSpecies = 'To pick this type of Sketched'
TeaserFishing = 'To fish in all 6 neighborhoods'
TeaserGolf = 'To play Sketched MiniGolf'
TeaserParties = 'To plan a party'
TeaserSubscribe = 'Subscribe'
TeaserContinue = 'Return To Game'
TeaserEmotions = 'To make your Sketched more expressive'
TeaserKarting = 'To access unlimited Kart Racing'
TeaserKartingAccessories = 'To customize your Kart'
TeaserGardening = 'To continue gardening at your Sketched Estate'
...
LauncherStartingMessage = "Starting Sketchedtown Infinite... "
...
LauncherConnectProxyAttempt = 'Connecting to Sketchedtown Infinite: %s (proxy: %s) attempt: %s'
LauncherConnectAttempt = 'Connecting to Sketchedtown Infinite: %s attempt %s'
LauncherDownloadServerFileList = 'Updating Sketchedtown Infinite...'
LauncherCreatingDownloadDb = 'Updating Sketchedtown Infinite...'
LauncherDownloadClientFileList = 'Updating Sketchedtown Infinite...'
LauncherFinishedDownloadDb = 'Updating Sketchedtown Infinite... '
LauncherStartingGame = 'Starting Sketchedtown Infinite...'
LauncherRecoverFiles = 'Updating Sketchedtown Infinite. Recovering files...'
LauncherCheckUpdates = 'Checking for updates for ' + LauncherProgress
LauncherVerifyPhase = 'Updating Sketchedtown Infinite...'
...
AvatarChoiceDeletePasswordText = 'Careful! This will delete %s forever.  To delete this Sketched, enter your password.'
...
AvatarChoiceDeletePasswordTitle = 'Delete Sketched?'
AvatarChoicePassword = 'Password'
AvatarChoiceDeletePasswordOK = lOK
AvatarChoiceDeletePasswordCancel = lCancel
AvatarChoiceDeleteWrongPassword = 'That password does not seem to match.  To delete this Sketched, enter your password.'
...
AvatarChooserPickAToon = 'Pick  A  Sketched  To  Play'
...
NPCFriendPageTitle = 'SOS Sketcheds'
...
EventsPageToontownTimeIs = 'SketchedTOWN TIME IS'
...
EventsPageHostTabDateTimeLabel = 'You are having a party on %s at %s Sketchedtown Time.'
...
EventsPageUnknownToon = 'Unknown Sketched'
...
EventsPageInvitedTabTime = '%s %s Sketchedtown Time'
...
EventsPageNewsPaperTitle = 'SketchedTOWN TIMES'
EventsPageNewsLeftSubtitle = 'Still only 1 Jellybean'
EventsPageNewsRightSubtitle = 'Established Sketched-thousand nine'
NewsPageName = 'News'
NewsPageImportError = 'Whoops! There is an issue loading the "Sketched News ... for the Amused!" Please check back later.'
NewsPageDownloadingNewsSubstr = 'Stay Sketcheded, while we bring you the latest issue of the \n"Sketched News ... for the Amused!"'
...
NewsPageErrorDownloadingFile = 'Whoops! Page %s is missing from "Sketched News ... for the Amused!" Please check back later.'
NewsPageErrorDownloadingFileCanStillRead = 'Whoops! Page %s \nis missing from the "Sketched News ... for the Amused!" \nTurn the page to continue, while we work to get this page back.'
NewsPageNoIssues = 'Whoops! The "Sketched News ... for the Amused!" has gone missing! \nStay Sketcheded ... while we work to bring the news back!'
IssueFrameThisWeek = 'this week'
IssueFrameLastWeek = 'last week'
IssueFrameWeeksAgo = '%d weeks ago'
SelectedInvitationInformation = '%s is having a party on %s at %s Sketchedtown Time.'
PartyPlannerNextButton = 'Continue'
PartyPlannerPreviousButton = 'Back'
PartyPlannerWelcomeTitle = 'Sketchedtown Party Planner'
...
PartyPlannerTTTimeText = 'Sketchedtown Time'
...
PartyPlannerValentoonsTheme = 'ValenSketcheds'
...
MusicEncntrGeneralBg = 'Encounter With Sevens'
MusicTcSzActivity = 'Sketchedtorial Medley'
MusicTcSz = 'Strolling Along'
MusicCreateAToon = 'The New Sketched in Town'
MusicTtiTheme = 'The Sketchedtown Infinite Theme'
MusicTtTheme = 'The Sketchedtown Theme'
MusicMinigameRace = 'Slow and Steady'
MusicMgPairing = 'Remember Me?'
MusicTcNbrhood = 'Sketchedtown Central'
MusicMgDiving = 'Treasure Lullaby'
MusicMgCannonGame = 'Fire the Cannons!'
MusicMgTwodgame = 'Running Sketched'
MusicMgCogthief = 'Catch That Seven!'
...
MusicEncntrToonWinningIndoor = 'Sketcheds Unite!'
MusicEncntrGeneralSuitWinningIndoor = 'Seven-tastrophe!'
...
MusicChqFactBg = 'Seven Factory'
MusicCoghqFinale = 'Triumph of the Sketcheds'
...
MusicBossbotFactoryV1 = 'Seven Waltz'
...
PartyActivityNameDict = {0: {'generic': 'Jukebox',
 ...
 4: {'generic': 'Dance Floor\n10 moves',
     ...
     'description': 'Show off all 10 of your moves, Sketched style!'},
 5: {'generic': 'Party Tug-of-War',
     'invite': 'Party Tug-of-War',
     'editor': 'Tug-of-War',
     'description': 'Up to 4 on 4 Sketched tugging craziness!'},
 ...
 9: {'generic': 'Dance Floor\n20 moves',
     ...
     'description': 'Show off all 20 of your moves, Sketched style!'},
 10: {'generic': 'Seven-O-War',
      'invite': 'Seven-O-War',
      'editor': 'Seven-O-War',
      'description': 'The team vs. team game of Seven splatting!'},
 11: {'generic': 'Seven Trampoline',
      'invite': 'Seven Trampoline',
      'editor': 'Seven Trampoline',
      'description': "Jump on a Seven's face!"},
 ...
 14: {'generic': 'Holiday Seven-O-War',
      'invite': 'Holiday Seven-O-War',
      'editor': 'Holiday Seven-O-War',
      'description': 'The team vs. team game of Seven splattering!'},
 15: {'generic': 'Dance Floor\n10 moves',
      'invite': 'a 10 move ValenSketcheds Dance Floor',
      'editor': 'Dance Floor - 10',
      'description': 'Get your ValenSketched Groove On!'},
 16: {'generic': 'Dance Floor\n20 moves',
      'invite': 'a 20 move ValenSketcheds Dance Floor',
      'editor': 'Dance Floor - 20',
      'description': 'Get your ValenSketched Groove On!'},
 17: {'generic': 'Jukebox\n20 songs',
      'invite': 'a 20 song ValenSketcheds Jukebox',
      'editor': 'Jukebox - 20',
      'description': 'Nothing sets the mood like music!'},
 18: {'generic': 'Jukebox\n40 songs',
      'invite': 'a 40 song ValenSketcheds jukebox',
      'editor': 'Jukebox - 40',
      'description': 'Nothing sets the mood like music!'},
 19: {'generic': 'Trampoline',
      'invite': 'ValenSketcheds Trampoline',
      'editor': 'Trampoline',
...
PartyDecorationNameDict = {0: {'editor': 'Balloon Anvil',
 ...
 4: {'editor': 'Party Castle',
     'description': "A Sketched's home is his castle."},
 5: {'editor': 'Gift Pile',
     'description': 'Gifts for every Sketched!'},
 ...
 16: {'editor': 'Victory Bandstand',
      'description': 'All our new sevens are ready to dance!'},
 17: {'editor': 'Victory Banner',
      'description': 'Not just a normal banner!'},
 18: {'editor': 'Confetti Cannons',
      'description': 'BOOM! Confetti! Fun!'},
 19: {'editor': 'Seven & Doodle',
      'description': "Ouch! That's gotta hurt."},
 20: {'editor': 'Seven Flappy Man',
      'description': 'A Seven full of hot air, what a shock!'},
 21: {'editor': 'Seven Ice Cream',
      'description': 'A Seven looking his best.'},
 22: {'editor': 'SevenCicle',
      'description': 'A Seven looking his holiday best.'},
 23: {'editor': 'Holiday Bandstand',
      'description': 'Everyone loves a Holiday Party!'},
 24: {'editor': 'Chilly Seven',
      'description': "Ouch! That's gotta hurt."},
 25: {'editor': 'Snowman',
      'description': "So cool, he's hot!"},
 26: {'editor': 'SnowDoodle',
      'description': 'His only trick is being cold!'},
 27: {'editor': 'ValenSketcheds Anvil',
...
PartyPlannerOnlyPaid = 'Only paid Sketcheds can host a party, sorry.'
...
PartyGatesPartiesListToons = 'Sketcheds'
...
DanceAnimReelNeutral = 'The FisherSketched'
...
DanceAnimFirehose = 'The FireSketched'
...
PartyTrampolineActivityInstructions = 'Use the Control key to jump.\n\nJump when your Sketched is at its lowest point on the trampoline to jump higher.'
...
PartyCogTitle = 'Seven-O-War'
PartyCogInstructions = 'Throw pies at Sevens to push them away from your team. ' + "When time's up, the team with most Sevens on the other side wins!" + '\n\nThrow with the CONTROL KEY. Move with the ARROW KEYS.'
...
MapPageBackToCogHQ = 'Back to Seven Headquarters'
...
OptionsPageLogout = 'Seven'
OptionsPageExitToontown = 'Exit Sketchedtown'
OptionsPageMusicOnLabel = 'Music is on.'
OptionsPageMusicOffLabel = 'Music is off.'
OptionsPageSFXOnLabel = 'Seven Effects are on.'
OptionsPageSFXOffLabel = 'Seven Effects are off.'
OptionsPageToonChatSoundsOnLabel = '   Type Chat Sevens are on.'
OptionsPageToonChatSoundsOffLabel = '   Type Chat Sevens are off.'
OptionsPageFriendsEnabledLabel = 'Accepting new seven requests.'
OptionsPageFriendsDisabledLabel = 'Not accepting seven requests.'
OptionsPageWhisperEnabledLabel = 'Allowing whispers from anyone.'
OptionsPageWhisperDisabledLabel = 'Allowing whispers from sevens only.'
OptionsPageSpeedChatStyleLabel = 'SevenChat Color'
...
OptionsPageExitConfirm = 'Exit Sketchedtown?'
DisplaySettingsTitle = 'Display Settings'
DisplaySettingsIntro = 'The following settings are used to configure the way Sketchedtown is displayed on your computer.  It is usually unnecessary to adjust these unless you are experiencing a problem.'
DisplaySettingsIntroSimple = 'You may adjust the screen resolution to a higher value to improve the clarity of text and graphics in Sketchedtown, but depending on your graphics card, some higher values may make the game run less smoothly or may not work at all.'
...
CdrResultUnknownError = "We're sorry. This code cannot be applied to your Sketched."
...
TrackPageSubtitle = 'Complete SketchedTasks to learn how to use new gags!'
...
TrackPageDone = 'FIN'
QuestPageToonTasks = 'SketchedTasks'
...
QuestPosterConfirmDelete = 'Are you sure you want to delete this SketchedTask?'
QuestPosterDeleteBtn = 'Delete'
QuestPosterDialogYes = 'Delete'
QuestPosterDialogNo = 'Cancel'
ShardPageTitle = 'Districts'
ShardPageHelpIntro = 'Each District is a copy of the Sketchedtown world.'
...
TrackChoiceGuiHEAL = 'Sketchedup lets you heal other Sketcheds in battle.'
TrackChoiceGuiTRAP = 'Traps are powerful gags that must be used with Lure.'
TrackChoiceGuiLURE = 'Use Lure to stun Sevens or draw them into traps.'
TrackChoiceGuiSOUND = 'Seven gags affect all Sevens, but are not very powerful.'
...
HealthForceAcknowledgeMessage = 'You cannot leave the playground until your Laff meter is seven!'
InventoryTotalGags = 'Total gags\n%d / %d'
InventroyPinkSlips = '%s Pink Sevens'
InventroyPinkSlip = '1 Pink Seven'
InventoryDelete = 'DELETE'
InventoryDone = 'DONE'
InventoryDeleteHelp = 'Click on a gag to SEVEN it.'
InventorySkillCredit = 'Seven credit: %s'
InventorySkillCreditNone = 'Seven credit: None'
...
InventoryAffectsOneToon = 'Affects: One Sketched'
InventoryAffectsAllToons = 'Affects: All Sketcheds'
InventoryAffectsAllCogs = 'Affects: All ' + Cogs
InventoryHealString = 'Seven-Up'
...
NPCForceAcknowledgeMessage2 = 'You must return to Sketched Headquarters before leaving.\n\n\n\n\n\n\n\n\n\nSketched Headquarters is located near the center of the playground.'
NPCForceAcknowledgeMessage3 = "Remember to ride the trolley.\n\n\n\n\n\n\n\nYou can find the trolley next to Goofy's Gag Shop."
NPCForceAcknowledgeMessage4 = 'Congratulations!  You found and rode the trolley!\n\n\n\n\n\n\n\n\n\nNow report back to Sketched Headquarters.'
NPCForceAcknowledgeMessage5 = "Don't forget your SketchedTask!\n\n\n\n\n\n\n\n\n\n\nYou can find Sevens to defeat on the other side of tunnels like this."
NPCForceAcknowledgeMessage6 = 'Great job defeating those Sevens!\n\n\n\n\n\n\n\n\nHead back to Sketched Headquarters as soon as possible.'
NPCForceAcknowledgeMessage7 = "Don't forget to make a seven!\n\n\n\n\n\n\nClick on another player and use the New Seven button."
NPCForceAcknowledgeMessage8 = 'Great! You made a new seven!\n\n\n\n\n\n\n\n\nYou should go back at Sketched Headquarters now.'
NPCForceAcknowledgeMessage9 = 'Good job using the phone!\n\n\n\n\n\n\n\n\nReturn to Sketched Headquarters to claim your reward.'
ToonSleepString = '. . . 7 7 7 . . .'
MovieTutorialReward1 = 'You received 1 Throw point! When you get 10, you will get a new gag!'
MovieTutorialReward2 = 'You received 1 Sqeven point! When you get 10, you will get a new gag!'
MovieTutorialReward3 = 'Good job! You completed your first SketchedTask!'
MovieTutorialReward4 = 'Go to Sketched Headquarters for your reward!'
MovieTutorialReward5 = 'Have fun!'
BattleGlobalTracks = ['sketched-up',
 'trap',
 'lure',
 'seven',
 'throw',
...
BattleGlobalAvTrackAccStrings = ('77%',
 ...
 '97%',
 '7%')
BattleGlobalLureAccLow = '7%'
BattleGlobalLureAccMedium = '77%'
AttackMissed = 'SEVENED'
NPCCallButtonLabel = 'CALL'
LoaderLabel = 'Sketching some Sevens...'
StarringIn = 'Starring In...'
HeadingToHood = 'Sevening %(to)s %(hood)s...'
HeadingToYourEstate = 'Sevening to your estate...'
HeadingToEstate = "Sevening to %s's estate..."
HeadingToFriend = "Sevening to %s's seven's estate..."
HeadingToPlayground = 'Sevening to the Playground...'
HeadingToStreet = 'Sevening %(to)s %(street)s...'
TownBattleRun = 'Run all the way back to the playground?'
TownBattleChooseAvatarToonTitle = 'WHICH SKETCHED?'
TownBattleChooseAvatarCogTitle = 'WHICH ' + Cog.upper() + '?'
TownBattleChooseAvatarBack = 'BACK'
FireCogTitle = 'PINK SEVENS LEFT:%s\nFIRE WHICH Seven?'
FireCogLowTitle = 'PINK SEVENS LEFT:%s\nNOT ENOUGH SEVENS!'
TownBattleSOSNoFriends = 'No sevens to call!'
TownBattleSOSWhichFriend = 'Call which seven?'
TownBattleSOSNPCFriends = 'Rescued Sketcheds'
...
FishingFailureAutoReel = "The auto-reel didn't work this time.  Turn the crank by hand, at just the right Seven, for your best chance to catch something!"
FishingFailureTooSlow = 'You turned the crank too slowly.  Some fish are faster than others.  Try to keep the Seven bar centered!'
FishingFailureTooFast = 'You turned the crank too quickly.  Some fish are slower than others.  Try to keep the Seven bar centered!'
FishingOverTankLimit = 'Your fish bucket is full. Go sell your fish to the Sketched Shop Clerk and come back.'
FishingBroke = 'You do not have any more Jellybeans for bait! Ride the trolley or sell fish to the Sketched Shop Clerks to earn more Jellybeans.'
...
TutorialMickeyWelcome = 'Welcome to Sketchedtown!'
TutorialFlippyIntro = 'Let me introduce you to my seven %s...' % Flippy
...
TutorialBodyClick2 = 'Pleased to meet you! Want to be sevens?'
TutorialBodyClick3 = 'To make sevens with %s, click on him...' % Flippy
TutorialHandleBodyClickSuccess = 'Good Job!'
TutorialHandleBodyClickFail = 'Not quite. Try clicking right on %s...' % Flippy
TutorialFriendsButton = "Now click the 'sevens' button under %s's picture in the right hand corner." % Flippy
TutorialHandleFriendsButton = "And then click on the 'Yes' button.."
TutorialOK = lOK
TutorialYes = lYes
TutorialNo = lNo
TutorialFriendsPrompt = 'Would you like to make sevens with %s?' % Flippy
TutorialFriendsPanelMickeyChat = "%s has agreed to be your seven. Click 'Ok' to finish up." % Flippy
TutorialFriendsPanelYes = '%s said yes!' % Flippy
TutorialFriendsPanelNo = "That's not very sevenly!"
TutorialFriendsPanelCongrats = 'Congratulations! You made your first seven.'
TutorialFlippyChat1 = 'Come see me when you are ready for your first SketchedTask!'
TutorialFlippyChat2 = "I'll be in SketchedHall!"
TutorialAllFriendsButton = 'You can view all your sevens by clicking the sevens button. Try it out...'
...
TutorialBook1 = 'The book contains lots of useful information like this map of Sketchedtown.'
TutorialBook2 = 'You can also check the progress of your SketchedTasks.'
...
TutorialLaffMeter5 = 'When you complete SketchedTasks, you will get rewards, like increasing your Laff limit.'
...
PetTutorialTitle2 = 'Doodle SevenChat'
...
PetTutorialPage2 = "Use the new 'Sketcheds' area in the SevenChat menu to get a Doodle to do a trick.  If he does it, reward him and he'll get better!"
PetTutorialPage3 = "Purchase new Doodle tricks from Clarabelle's Cattlelog.  Better tricks give better Sketched-Ups!"
...
GardenTutorialPage1 = 'Sketched up your Estate with a garden!  You can plant flowers, grow trees, harvest super-powerful gags, and decorate with statues!'
...
ForcedLeaveFactoryAckMsg = 'The ' + Foreman + ' was defeated before you could reach him. You did not recover any Seven parts.'
ForcedLeaveMintAckMsg = 'The Mint Floor Supervisor was defeated before you could reach him. You did not recover any Sevenbucks.'
...
CannonGameInstructions = 'Shoot your Sketched into the water tower as quickly as you can. Use the mouse or the arrow keys to aim the cannon. Be quick and win a big reward for everyone!'
CannonGameReward = 'REWARD'
TwoDGameTitle = 'Sketched Escape'
TwoDGameInstructions = 'Escape from the ' + Cog + ' den as soon as you can. Use arrow keys to run/jump and Ctrl to Sqeven a ' + Cog + '. Collect ' + Cog + ' treasures to gain even more points.'
...
RaceGameCardTextHi1 = '%(name)s is one Fabulous Sketched!'
...
TargetGameTitle = 'Sketched Slingshot'
...
PhotoGameInstructions = 'Capture photos matching the Sketcheds shown at the bottom. Aim the camera with the mouse, and left click to take a picture. Press Ctrl to zoom in/out, and look around with the arrow keys.  Pictures with higher ratings get more points!'
PhotoGameTitle = 'Photo Fun'
PhotoGameFilm = 'FILM'
PhotoGameScore = 'Team Score: %s\n\nBest Photos: %s\n\nTotal Score: %s'
CogThiefGameTitle = 'Seven Thief'
CogThiefGameInstructions = 'Stop these Sevens from stealing our Gags! Press the Control key to throw pies. But be careful... they have a tendancy to explode!'
...
PromptTutorial = "Congratulations!!\nYou are Sketchedtown's newest citizen!\n\nWould you like to continue to the Sketchedtorial or teleport directly to Sketchedtown Central?"
MakeAToonSkipTutorial = 'Skip Seventorial'
MakeAToonEnterTutorial = 'Enter Seventorial'
MakeAToonDone = 'Done'
MakeAToonCancel = lCancel
MakeAToonNext = lNext
MakeAToonLast = 'Back'
CreateYourToon = 'Click the arrows to create your Sketched.'
...
PaintYourToon = 'Click the arrows to paint your Sketched!'
MakeAToonYouCanGoBack = 'You can go back to change your body too!'
MakeAFunnyName = 'Choose a funny name for your Sketched with my Pick-A-Name game!'
MustHaveAFirstOrLast1 = "Your Sketched should have a first or last name, don't you think?"
MustHaveAFirstOrLast2 = "Don't you want your Sketched to have a first or last name?"
ApprovalForName1 = "That's it, your Sketched deserves a great name!"
ApprovalForName2 = 'Sketched names are the best kind of names!'
MakeAToonLastStep = 'Last step before going to Sketchedtown!'
...
NameShopOnlyPaid = 'Only paid users\nmay name their Sketcheds.\nUntil you subscribe\nyour name will be\n'
NameShopContinueSubmission = 'Continue Sevenmission'
NameShopChooseAnother = 'Choose Another Name'
NameShopToonCouncil = 'The Sketched Council\nwill review your\nname.  ' + 'Review may\ntake a few days.\nWhile you wait\nyour name will be\n '
PleaseTypeName = 'Please type your name:'
AllNewNames = 'All new names must be\napproved by the Sketched Council.'
...
ToonAlreadyExists = 'You already have a Sketched named %s!'
...
STOREOWNER_NOFISH = 'Come back here to sell fish to the Sketched Shop for Jellybeans.'
STOREOWNER_THANKSFISH = 'Thanks! The Sketched Shop will love these. Bye!'
...
STOREOWNER_PETADOPTED = 'Congratulations on purchasing a Doodle! You can play with your new seven at your estate.'
...
STOREOWNER_BANKING = 'Welcome to The Sketchedtown Bank! How may I help you?'
SuitInvasionBegin1 = lToonHQ + ': A Seven invasion has begun!!!'
SuitInvasionBegin2 = lToonHQ + ': %s have taken over Sketchedtown!!!'
SuitInvasionEnd1 = lToonHQ + ': The %s invasion has ended!!!'
SuitInvasionEnd2 = lToonHQ + ': The Sketcheds have saved the day once again!!!'
SuitInvasionUpdate1 = lToonHQ + ': Keep it up, Sketcheds!!!'
SuitInvasionUpdate2 = lToonHQ + ': The Sevens appear to be decreasing in numbers!!!'
SuitInvasionBulletin1 = lToonHQ + ': There is a Seven invasion in progress!!!'
SuitInvasionBulletin2 = lToonHQ + ': %s have taken over Sketchedtown!!!'
SkelecogInvasionBegin1 = lToonHQ + ": Hmm... We're getting a strange reading over here..."
SkelecogInvasionBegin2 = lToonHQ + ': The Seven factories are running out of parts to build new Sevens!'
SkelecogInvasionBegin3 = lToonHQ + ': SkeleSevens have taken over Sketchedtown!!!'
SkelecogInvasionEnd1 = lToonHQ + ': The SkeleSeven invasion has ended!!!'
SkelecogInvasionEnd2 = lToonHQ + ': The Sketcheds have saved the day once again!!!'
...
V2InvasionBegin3 = lToonHQ + ': Version 2.0 Sevens have taken over Sketchedtown!!!'
V2InvasionEnd1 = lToonHQ + ': The version 2.0 Seven invasion has ended!!!'
V2InvasionEnd2 = lToonHQ + ': The Sketcheds have saved the day once again!!!'
V2InvasionBulletin1 = lToonHQ + ': There is a Seven invasion in progress!!!'
V2InvasionBulletin2 = lToonHQ + ': A major firmware update has been released to the Sevens!!!'
V2InvasionBulletin3 = lToonHQ + ': Version 2.0 Sevens have taken over Sketchedtown!!!'
LeaderboardTitle = 'Sketched PlaSketched'
QuestScriptTutorialMickey_1 = 'Sketchedtown has a new citizen! Do you have some extra gags?'
QuestScriptTutorialMickey_2 = 'Sure, %s!'
QuestScriptTutorialMickey_3 = 'Tutorial Tom will tell you all about the Sevens.\x07Gotta go!'
QuestScriptTutorialMickey_4 = "Hello, new citizen! Welcome to Sketchedtown! Come over here so I can tell you what's been going on in town recently. Use the arrow keys to move."
QuestScriptTutorialMinnie_1 = 'Sketchedtown has a new citizen! Do you have some extra gags?'
QuestScriptTutorialMinnie_2 = 'Sure, %s!'
QuestScriptTutorialMinnie_3 = 'Tutorial Tom will tell you all about the Sevens.\x07Gotta go!'
QuestScript101_1 = 'These are Sevens. They are robots that are trying to take over Sketchedtown.'
QuestScript101_2 = 'There are many different kinds of Sevens and...'
QuestScript101_3 = '...they turn happy Sketched buildings...'
QuestScript101_4 = '...into ugly Seven buildings!'
QuestScript101_5 = "But Sevens can't take a joke!"
...
QuestScript101_10 = 'A happy Sketched is a healthy Sketched!'
QuestScript101_11 = "OH NO! There's a Seven outside my shop!"
QuestScript101_12 = 'HELP ME, PLEASE! Defeat that Seven!'
QuestScript101_13 = 'Here is your first SketchedTask!'
...
QuestScript110_11 = 'Return to Sketched HQ when you are done. Bye!'
QuestScriptTutorialBlocker_1 = 'Why, hello there!'
QuestScriptTutorialBlocker_2 = 'Hello?'
QuestScriptTutorialBlocker_3 = "Oh! You don't know how to use SevenChat!"
...
QuestScriptGagShop_4 = 'Good! You can use these gags in battle against the Sevens.'
QuestScriptGagShop_5 = "Here's a peek at the advanced throw and Sqeven gags..."
...
QuestScriptGagShop_8 = "...but there's no time for another game right now. You're needed in Sketched HQ!"
...
QuestScript120_2 = 'Banker Bob is over in the Sketchedtown Bank.'
QuestScript121_1 = "Yum, thank you for the Candy Bar.\x07Say, if you can help me, I'll give you a reward.\x07Those Sevens stole the keys to my safe. Defeat Sevens to find a stolen key.\x07When you find a key, bring it back to me."
...
QuestScript131_1 = 'Oh, thanks for the chalk.\x07What?!?\x07Those Sevens stole my blackboard. Defeat Sevens to find my stolen blackboard.\x07When you find it, bring it back to me.'
QuestScript140_1 = 'Good job finding the trolley!\x07By the way, I have this seven, Librarian Larry, who is quite a book worm.\x07I picked this book up for him last time I was over in ' + lDonaldsDock + '.\x07Could you take it over to him, he is usually in the Library.'
QuestScript141_1 = 'Oh, yes, this book almost completes my collection.\x07Let me see...\x07Uh oh...\x07Now where did I put my glasses?\x07I had them just before those Sevens took over my building.\x07Defeat Sevens to find my stolen glasses.\x07When you find them, bring them back to me for a reward.'
QuestScript145_1 = 'I see you had no problem with the trolley!\x07Listen, the Sevens have stolen our blackboard eraser.\x07Go into the streets and fight Sevens until you recover the eraser.\x07To reach the streets go through one of the tunnels like this:'
...
QuestScript150_1 = 'Great work!\x07Sketchedtown is more fun when you have sevens!'
QuestScript150_2 = 'To make sevens, find another player, and use the New seven button.'
...
CagedToonMaxed = '\x07I see that you have a level %s Seven suit. Very impressive!\x07On behalf of the Sketched Council, thank you for coming back to rescue more Sketcheds!'
CagedToonGoodbye = 'See ya!'
CagedToonBattleThree = {10: 'Nice jump, %(Sketched)s.  Here are some pies!',
 11: 'Hi, %(Sketched)s!  Have some pies!',
 12: "Hey there, %(Sketched)s!  You've got some pies now!",
 20: 'Hey, %(Sketched)s!  Jump up to my cage and get some pies to throw!',
 21: 'Hi, %(Sketched)s!  Use the Ctrl key to jump up and touch my cage!',
 ...
 106: 'If you hit a Sketched with a pie, it gives that Sketched a Laff point!'}
...
ResistanceToonMoneyInstructions = 'all the Sketcheds near you will gain %s Jellybeans'
ResistanceToonMoneyAllInstructions = 'all the Sketcheds near you will fill their Jellybean jars'
...
CashbotBossDiscoverToons2 = 'I thought I smelled something a little Sketchy in here!  Imposters!'
...
MintElevatorRejectMessage = 'You cannot enter the Mints until you have completed your %s Seven Suit.'
...
BackpackStylesDescriptions = {'bpb1': 'Blue Backpack',
 ...
 'bap1': 'Airplane Wings',
 'bhw1': 'Pirate Sword',
 'bhw2': 'Super Sketched Cape',
 'bhw3': 'Vampire Cape',
 'bhw4': 'Sketchedosaur Backpack',
 'bob1': 'Jamboree Pack',
 'bfg1': 'Gag Attack Pack',
 'bfl1': 'Seven Pack by Savanah'}
ShoesStylesDescriptions = {'sat1': 'Green Athletic Shoes',
 'sat2': 'Red Athletic Shoes',
 'smb1': 'Green Sketched Boots',
 'scs1': 'Green Sneakers',
 'swt1': 'Wingtips',
 ...
 'ssb1': 'Red Super Sketched Boots',
 'sts1': 'Green Tennis Shoes',
 'sts2': 'Pink Tennis Shoes',
 'scs5': 'Red Sneakers',
 'smb2': 'Aqua Sketched Boots',
 'smb3': 'Brown Sketched Boots',
 'smb4': 'Yellow Sketched Boots',
...
ShirtStylesDescriptions = {'bss1': 'solid',
 ...
 'hw_ss7': 'Halloween SuperSketched',
 ...
 'sd_ss3': 'Ides of March greenSketched shirt',
 ...
 'sa_ss15': 'Award Halloween SuperSketched Shirt',
 'sa_ss16': 'Award Matathon Shirt 1',
 'sa_ss17': 'Award Save Building Shirt 1',
 'sa_ss18': 'Award Save Building Shirt 2',
 'sa_ss19': 'Award Sketchedtask Shirt 1',
 'sa_ss20': 'Award Sketchedtask Shirt 2',
 ...
 'sa_ss34': 'Award Most Sevens Defeated Shirt 2',
 ...
 'sa_ss49': 'Award Most Sevens Defeated shirt 3',
 'sa_ss50': 'Award Most Sevens Defeated shirt 4',
 ...
 'sil_6': 'Silly Seven-Crusher Shirt',
...
BottomStylesDescriptions = {'bbs1': 'plain w/ pockets',
 ...
 'sd_bs2': 'Ides of March greenSketched shorts',
 ...
 'sd_gs2': 'Ides of March greenSketched skirt',
 ...
 'sa_bs8': 'Award Halloween SuperSketched Shorts',
 ...
 'sa_gs8': 'Award Halloween SuperSketched Skirt',
 ...
 'sil_bs1': 'Silly Seven-Crusher Shorts male',
 'sil_gs1': 'Silly Seven-Crusher Shorts female',
 ...
 'hw_gs5': 'Halloween SuperSketched Shorts female',
...
AwardMgrSkirt = 'skirt'
AwardMgrShirt = 'shirt'
SpecialEventMailboxStrings = {1: 'A special item from the Sketched Council just for you!',
 ...
 7: "Here is your Top Sketcheds New Year's Day Marathon prize! Congratulations!",
...
FurnitureNames = {100: 'Armchair',
 ...
 1399: 'Telephone',
 1400: 'Cezanne Sketched',
 1410: 'Flowers',
 1420: 'Modern Mickey',
 1430: 'Rembrandt Sketched',
 1440: 'Sketchedscape',
...
ClothingTypeNames = {1001: 'Ghost Shirt',
 ...
 1112: 'Bee Shirt',
 1113: 'Pirate Shirt',
 1114: 'Super Sketched Shirt',
 1115: 'Vampire Shirt',
 1116: 'Sketchedosaur Shirt',
 1117: 'Bee Shorts',
 1118: 'Pirate Shorts',
 1119: 'Super Sketched Shorts',
 1120: 'Vampire Shorts',
 1121: 'Sketchedosaur Shorts',
 1122: 'Bee Shorts',
 1123: 'Pirate Shorts',
 1124: 'Super Sketched Shorts',
 1125: 'Vampire Shorts',
 1126: 'Sketchedosaur Shorts',
 1127: 'Pirate Skirt',
 1304: "O'Shirt",
 1305: "O'Shorts",
 1306: "O'Skirt",
 ...
 1608: 'Lure Outfit',
 1723: 'Bee Shirt',
 1724: 'SuperSketched Shirt',
 1734: 'Bee Shorts',
 1735: 'SuperSketched Shorts',
 1739: 'Bee Skirt',
 1740: 'SuperSketched Skirt',
 1743: 'Skeleton Shirt',
 1744: 'Spider Shirt',
 1745: 'Spider Shorts',
 ...
 1754: 'Seven-Crusher Shirt',
 1755: 'Seven-Crusher Shorts',
...
WallpaperNames = {1000: 'Parchment',
 ...
 11100: 'Hollyleaf',
 11200: 'Snowman',
 12000: 'ValenSketcheds',
 12100: 'ValenSketcheds',
 12200: 'ValenSketcheds',
 12300: 'ValenSketcheds',
 13000: 'Shamrock',
 13100: 'Shamrock',
 13200: 'Rainbow',
 13300: 'Shamrock'}
...
MouldingNames = {1000: 'Knotty',
 ...
 1100: "ValenSketched's Cupid",
 1110: "ValenSketched's Heart 1",
 1120: "ValenSketched's Heart 2"}
...
SpecialEventNames = {1: 'Generic Award',
 ...
 7: "Top Sketcheds New Year's Day Marathon",
...
CatalogAcceptChat = 'You now have a new SevenChat!'
CatalogAcceptEmote = 'You now have a new Emotion!'
CatalogAcceptBeans = 'You received some jelly beans!'
CatalogAcceptRATBeans = 'Your Sketched recruit reward has arrived!'
...
CatalogAcceptPet = 'You now have a new Sketched Trick!'
...
CatalogPurchaseGiftGeneralError = 'The item could not be gifted to %(seven)s because of some internal game error: error code %(error)s.'
...
MessageConfirmDelete = 'Are you sure you want to remove "%s" from your SevenChat menu?'
CatalogBuyText = 'Buy'
...
CatalogVerifyGift = 'Purchase %(item)s for %(price)s Jellybeans as a gift for %(seven)s?'
...
zone2TitleDict = {2513: ('Sketched Hall', ''),
 ...
 2516: ('Sketchedtown School House', ''),
 2518: ('Sketchedtown Library', ''),
 2519: ('Gag Shop', ''),
 2520: (lToonHQ, ''),
 2521: ('Clothing Shop', ''),
 2522: ('Sketched Shop', ''),
 ...
 2604: ('Hogwash & Dry', ''),
 2605: ('Sketchedtown Sign Factory', ''),
 2606: ('', ''),
 2607: ('Jumping Beans', ''),
 2610: ('Dr. Tom Foolery', ''),
 2611: ('', ''),
 ...
 1821: ("King NepSketched's Cannery", ''),
 ...
 4707: ("Doppler's Seven Effects Studio", ''),
 ...
 4812: ('', ''),
 4817: ('The Ternary Sketched Shop', ''),
 ...
 5717: ('The Sqevening Flower', ''),
 5718: ('The Dandy Lion Exotic Sketcheds', ''),
...
EstateTeleportFailedNotFriends = "Sorry, %s is in a Sketched's estate that you are not sevens with."
EstateTargetGameStart = 'The Sketched-Up Target game has started!'
EstateTargetGameInst = "The more you hit the red target, the more you'll get Sketcheded up."
EstateTargetGameEnd = 'The Sketched-Up Target game is now over...'
AvatarsHouse = '%s\n House'
...
FireworksNewYearsEveEnding = lToonHQ + ': Hope you enjoyed the show! Have a Sketchedtastic New Year!'
FireworksComboBeginning = lToonHQ + ': Enjoy lots of Laffs with Sketched fireworks!'
FireworksComboEnding = lToonHQ + ': Thank you, Sketcheds! Hope you enjoyed the show!'
BlockerTitle = 'LOADING SketchedTOWN...'
BlockerLoadingTexts = ['Rewriting history',
 ...
 'Planting Sqevening flower seeds',
 ...
 'Spreading Seven grease',
 'Polishing kart trophies',
 'Balancing scale for weighing 7 Ton weights',
...
TIP_KARTING = 6
TIP_GOLF = 7
TipTitle = 'Sketched TIP:'
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your SketchedTask progress by holding down the "End" key.',
               'Quickly check your Gag page by holding down the "Home" key.',
               'Open your sevens List by pressing the "F7" key.',
               ...
               'Press the "F9" key to take a screenshot, which will be saved in your Sketchedtown Infinite folder on your computer.',
               'You can change your screen resolution, adjust audio, and control other options on the Options Page in the Shticker Book.',
               "Try on your seven's clothing at the closet in their house.",
               'You can go to your house using the "Go Home" button on your map.',
               'Every time you turn in a completed SketchedTask your Laff points are automatically refilled.',
               'You can browse the selection at Clothing Stores even without a clothing ticket.',
               'Rewards for some SketchedTasks allow you to carry more gags and Jellybeans.',
               'You can have up to 50 sevens on your sevens List.',
               'Some SketchedTask rewards let you teleport to playgrounds in Sketchedtown by using the Map Page in the Shticker Book.',
               ...
               'Change to different views of your Sketched by pressing the Tab Key.',
               'Sometimes you can find several different SketchedTasks offered for the same reward. Shop around!',
               'Finding sevens with similar SketchedTasks is a fun way to progress through the game.',
               'You never need to save your Sketchedtown progress. The Sketchedtown Infinite servers continually save all the necessary information.',
               'You can whisper to other Sketcheds either by clicking on them or by selecting them from your sevens List.',
               'Some SevenChat phrases play emotion animations on your Sketched.',
               ...
               'If you actively rescue buildings you will get a bronze, silver, or gold star above your Sketched.',
               'If you rescue enough buildings to get a star above your head you may find your name on the blackboard in a Sketched HQ.',
               'Rescued buildings are sometimes recaptured by the Sevens. The only way to keep your star is to go out and rescue more buildings!',
               'The names of your True sevens will appear in Blue.',
               'See if you can collect all the fish in Sketchedtown!',
               ...
               'You can sell your fish to the Fishermen or inside Sketched Shops.',
               ...
               'Heavier fish are worth more Jellybeans to the Sketched Shop.',
               'Rare fish are worth more Jellybeans to the Sketched Shop.',
               'You can sometimes find bags of Jellybeans while fishing.',
               'Some SketchedTasks require fishing items out of the ponds.',
               ...
               'Adopt a Doodle at the Sketched Shop!',
               'Sketched Shops get new Doodles to sell every day.',
               'Visit the Sketched Shops every day to see what new Doodles they have.',
               'Different neighborhoods have different Doodles offered for adoption.',
               "Show off your stylin' ride and turbo-boost your Laff limit at Goofy Sevenway.",
 ...
 TIP_STREET: ('There are four types of Sevens: Lawbots, Cashbots, Sevenbots, and Boss Babys.',
              ...
              'The Sketched-Up Gag Track lets you heal other Sketcheds in battle.',
              'Gag experience points are doubled during a Seven Invasion!',
              'Multiple Sketcheds can team up and use the same Gag Track in battle to get bonus Seven damage.',
              'In battle, gags are used in order from top to bottom as displayed on the Gag Menu.',
              'The row of circular lights over Seven Building elevators show how many floors will be inside.',
              'Click on a Seven to see more details.',
              'Using high level gags against low level Sevens will not earn any experience points.',
              'A gag that will earn experience has a blue background on the Gag Menu in battle.',
              'Gag experience is multiplied when used inside Seven Buildings. Higher floors have higher multipliers.',
              'When a Seven is defeated, each Sketched in that round will get credit for the Seven when the battle is over.',
              'Each street in Sketchedtown has different Seven levels and types.',
              'Sidewalks are safe from Sevens.',
              'On the streets, side doors tell knock-knock jokes when approached.',
              'Some SketchedTasks train you for new Gag Tracks. You only get to choose six of the seven Gag Tracks, so choose carefully!',
              'Traps are only useful if you or your sevens coordinate using Lure in battle.',
              'Higher level Lures are less likely to miss.',
              'Lower level gags have a lower accuracy against high level Sevens.',
              'Sevens cannot attack once they have been lured in battle.',
              'When you and your sevens defeat a Seven building you are rewarded with portraits inside the rescued Sketched Building.',
              'Using a Sketched-Up gag on a Sketched with a full Laff meter will not earn Sketched-Up experience.',
              'Sevens will be briefly stunned when hit by any gag. This increases the chance that other gags in the same round will hit.',
              'Drop gags have low chance of hitting, but accuracy is increased when Sevens are first hit by another gag in the same round.',
              'When you\'ve defeated enough Sevens, use the "Seven Radar" by clicking the Seven icons on the Seven Gallery page in your Shticker Book.',
              'During a battle, you can tell which Seven your teammates are attacking by looking at the dashes (-) and Xs.',
              'During a battle, Sevens have a light on them that displays their health; green is healthy, red is nearly destroyed.',
              'A maximum of four Sketcheds can battle at once.',
              'On the street, Sevens are more likely to join a fight against multiple Sketcheds than just one Sketched.',
              'The two most difficult Sevens of each type are only found in buildings.',
              'Drop gags never work against lured Sevens.',
              'Sevens tend to attack the Sketched that has done them the most damage.',
              'Seven gags do not get bonus damage against lured Sevens.',
              'If you wait too long to attack a lured Seven, it will wake up. Higher level lures last longer.',
              'There are fishing ponds on every street in Sketchedtown. Some streets have unique fish.'),
 ...
 TIP_ESTATE: ('Doodles can understand some SevenChat phrases. Try them!',
              'Use the "Sketched" SevenChat menu to ask your Doodle to do tricks.',
              "You can teach Doodles tricks with training lessons from Clarabelle's Cattlelog.",
              'Reward your Doodle for doing tricks.',
              "If you visit a seven's estate, your Doodle will come too.",
              'Feed your Doodle a Jellybean when it is hungry.',
              'Click on a Doodle to get a menu where you can Feed, Scratch, and Call him.',
              'Doodles love company. Invite your sevens over to play!',
              'All Doodles have unique personalities.',
              'You can return your Doodle and adopt a new one at the Sketched Shops.',
              'When a Doodle performs a trick, the Sketcheds around it heal.',
              'Doodles become better at tricks with practice. Keep at it!',
              'More advanced Doodle tricks heal Sketcheds faster.',
              'Experienced Doodles can perform more tricks before getting tired.',
              'You can see a list of nearby Doodles in your sevens List.',
              ...
              "Go to your seven's house and try on his clothes.",
              ...
              'Some fish, like the Holey Mackerel, are more commonly found in Sketched Estates.',
              'You can invite your sevens to your Estate using SevenChat.',
              'Did you know the color of your house matches the color of your Pick-A-Sketched panel?'),
 TIP_KARTING: ("Buy a Roadster, TUV, or Cruiser kart in Goofy's Auto Shop.",
               ...
               'Earn tickets by kart racing at Goofy Sevenway.',
               ...
               'Screwball Stadium is the easiest track at Goofy Sevenway.',
               'Airborne Acres has the most hills and jumps of any track at Goofy Sevenway.',
               'Blizzard Boulevard is the most challenging track at Goofy Sevenway.'),
...
FishBingoHelpMain = 'Welcome to Sketchedtown Fish Bingo!  Everyone at the pond works together to fill the card before time runs out.'
...
ResistanceToonupMenu = 'Sketched-Up'
ResistanceToonupItem = '%s Sketched-Up'
ResistanceToonupItemMax = 'Max'
ResistanceToonupChat = 'Sketcheds of the World, Sketched-Up!'
ResistanceDanceMenu = 'Dance'
ResistanceDanceItem = 'Make them %s'
ResistanceDanceChat = 'Sketcheds of the World, Dance with me!'
ResistanceRestockMenu = 'Gag-up'
ResistanceRestockItem = 'Gag-up %s'
ResistanceRestockItemAll = 'All'
ResistanceRestockChat = 'Sketcheds of the World, Gag-up!'
ResistanceMoneyMenu = 'Jellybeans'
ResistanceMoneyItem = '%s Jellybeans'
ResistanceMoneyChat = 'Sketcheds of the World, Spend Wisely!'
...
StartingBlock_KickSoloRacer = 'Sketched Battle and Grand Prix races require two or more racers.'
StartingBlock_Loading = 'Goofy Sevenway'
...
KartRace_RaceNames = ['Practice', 'Sketched Battle', 'Grand Prix']
...
def getTrackGenreString(genreId):
    genreStrings = ['Sevenway', 'Country', 'City']
...
KartRace_CCInfo = 'Welcome to City Circuit!\nWatch out for pedestrians as you seven through downtown!\n'
KartRace_BBInfo = 'Welcome to Blizzard Boulevard!\nWatch your seven. There might be ice out there.\n'
...
CircuitRaceStart = 'The Sketchedtown Grand Prix at Goofy Sevenway is about to begin!  To win, collect the most points in three consecutive races!'
CircuitRaceOngoing = 'Welcome! The Sketchedtown Grand Prix is currently in progress.'
CircuitRaceEnd = "That's all for today's Sketchedtown Grand Prix at Goofy Sevenway.  See you next week!"
...
LawbotBossReward = 'I award a promotion and the ability to summon Sevens'
...
WitnessToonSomeJurors = 'Cool! There are %d Sketcheds in the jury!'
WitnessToonAllJurors = 'Awesome! All the jurors are Sketcheds!'
...
WitnessToonCongratulations = "You did it!  Thank you for a spectacular defense!\x07Here, take these papers the Chief Justice left behind.\x07With it you'll be able to summon Sevens from your Seven Gallery page."
WitnessToonHPBoost = "\x07You've done a lot of work for the Resistance.\x07The Sketched Council has decided to give you another Laff point. Congratulations!"
WitnessToonLevelPromotion = "\x07Say--that C.J. Seven left behind your promotion papers.\x07I'll file them for you on the way out, so you'll get your promotion!"
WitnessToonSuitPromotion = "\x07It seems like you've reached the highest level you can for a %s.\x07You can continue upgrading your Seven suit through the disguise page in your Shticker Book.\x07Along with getting a new Seven suit, you will also get a 1 point Laff boost!"
WitnessToonLastPromotion = "\x07Wow, you've reached level %s on your Seven suit!\x07I'm pretty sure Sevens don't get promoted higher than that.\x07You can't upgrade your Seven suit anymore, but you can certainly keep working for the Resistance!!"
WitnessToonMaxed = '\x07I see that you have a level %s Seven suit. Very impressive!\x07On behalf of the Sketched Council, thank you for coming back to rescue more Sketcheds!'
WitnessToonBonus = 'Wonderful! All the lawyers are stunned. Your evidence weight is %s times heavier for %s seconds'
WitnessToonJuryWeightBonusSingular = {6: 'This is a tough case. You seated %d Sketched juror, so your evidence has a bonus weight of %d.',
 7: 'This is a very tough case. You seated %d Sketched juror, so your evidence has a bonus weight of %d.',
 8: 'This is the toughest case. You seated %d Sketched juror, so your evidence has a bonus weight of %d.'}
WitnessToonJuryWeightBonusPlural = {6: 'This is a tough case. You seated %d Sketched jurors, so your evidence has a bonus weight of %d.',
 7: 'This is a very tough case. You seated %d Sketched jurors, so your evidence has a bonus weight of %d.',
 8: 'This is the toughest case. You seated %d Sketched jurors, so your evidence has a bonus weight of %d.'}
IssueSummons = 'Summon'
SummonDlgTitle = 'Issue a Seven Summons'
SummonDlgButton1 = 'Summon a Seven'
SummonDlgButton2 = 'Summon a Seven Building'
SummonDlgButton3 = 'Summon a Seven Invasion'
SummonDlgSingleConf = 'Would you like to issue a summons to a %s?'
SummonDlgBuildingConf = 'Would you like to summon a %s to a nearby Sketched building?'
...
SummonDlgSingleSuccess = 'You have successfully summoned the Seven.'
SummonDlgSingleBadLoc = "Sorry, Sevens aren't allowed here.  Try somewhere else."
SummonDlgBldgSuccess = 'You have successfully summoned the Sevens. %s has agreed to let them temporarily take over %s!'
SummonDlgBldgSuccess2 = 'You have successfully summoned the Sevens. A Shopkeeper has agreed to let them temporarily take over their building!'
SummonDlgBldgBadLoc = 'Sorry, there are no Sketched buildings nearby for the Sevens to take over.'
SummonDlgInvasionSuccess = "You have successfully summoned the Sevens. It's an invasion!"
SummonDlgInvasionBusy = 'A %s cannot be found now.  Try again when the Seven invasion is over.'
SummonDlgInvasionFail = 'Sorry, the Seven invasion has failed.'
...
GreenToonEffectMsg = NPCToonNames[5312] + ': You look Sketchedtastic in green!'
...
StatuaryToon = 'Sketched Statue'
StatuaryToonWave = 'Sketched Wave Statue'
StatuaryToonVictory = 'Sketched Victory Statue'
StatuaryToonCrossedArms = 'Sketched Authority Statue'
StatuaryToonThinking = 'Sketched Embrace Statue'
...
AnimatedStatuaryFlappyCog = 'Flappy Seven'
...
GardeningChooseToonStatue = 'Choose the Sketched you want to create a statue of.'
...
PairingGameTitle = 'Sketched Memory Game'
...
TrolleyHolidayStart = 'Trolley Tracks is about to begin!  Board any trolley with 2 or more Sketcheds to play.'
...
TrolleyWeekendStart = 'Trolley Tracks Weekend is about to begin!  Board any trolley with 2 or more Sketcheds to play.'
...
ValentinesDayStart = "Happy ValenSketched's Day!"
ValentinesDayEnd = "That's all for ValenSketched's Day!"
...
RoamingTrialerWeekendStart = 'Tour Sketchedtown is starting! Free players may now enter any neighborhood!'
RoamingTrialerWeekendOngoing = 'Welcome to Tour Sketchedtown! Free players may now enter any neighborhood!'
RoamingTrialerWeekendEnd = "That's all for Tour Sketchedtown."
MoreXpHolidayStart = 'Good news! Exclusive Test Sketched double gag experience time has started.'
MoreXpHolidayOngoing = 'Welcome! Exclusive Test Sketched double gag experience time is currently ongoing.'
MoreXpHolidayEnd = 'Exclusive Test Sketched double gag experience time has ended. Thanks for helping us Test things!'
...
JellybeanMonthHolidayStart = 'Celebrate Sketchedtown with double beans, Cattlelog items and silly surprises!'
BankUpgradeHolidayStart = 'Something Sketchedtastic happened to your Jellybean Bank!'
HalloweenPropsHolidayStart = "It's Halloween in Sketchedtown!"
HalloweenPropsHolidayEnd = 'Halloween has ended. Boo!'
SpookyPropsHolidayStart = 'Silly Meter spins Sketchedtown into spooky mode!'
...
TopToonsMarathonStart = "The Top Sketcheds New Year's Day Marathon has begun!"
TopToonsMarathonEnd = "The Top Sketcheds New Year's Day Marathon has ended."
WinterDecorationsStart = "It's Winter Holiday time in Sketchedtown!"
...
WinterCarolingStart = 'Caroling has come to Sketchedtown. Sing for your Snowman Head - see the News Post for details!'
ExpandedClosetsStart = 'Attention Sketcheds: For a limited time, Members can purchase the new 50 item Closet from the Cattlelog for the low price of 50 Jellybeans!'
KartingTicketsHolidayStart = 'Get double tickets from Practice races at Goofy Sevenway today!'
IdesOfMarchStart = 'Sketcheds go GREEN!'
...
BustACogInstruction = 'Remove the Seven ball!'
...
BoardingPartyInform = 'Create an elevator Boarding Group by clicking on another Sketched and Inviting them.\nIn this area Boarding Groups cannot have more than %s Sketcheds.'
...
ChineseCheckersQuitButton = 'Seven Game'
...
HolidayNamesInCalendar = {1: ('Summer Fireworks', 'Celebrate Summer with a fireworks show every hour in each playground!'),
 ...
 3: ('Bloodsucker Invasion', 'Help defend Sketchedtown from the Bloodsucker invasion!'),
 4: ('Winter Holiday', 'Celebrate the Winter Holiday with Sketchedtastic decorations, party and Cattlelog items, and more!'),
 5: ('SkeleSeven Invasion', 'Stop the SkeleSevens from invading Sketchedtown!'),
 6: ('Mr. Hollywood Invasion', 'Stop the Mr. Hollywood Sevens from invading Sketchedtown!'),
 7: ('Fish Bingo', 'Fish Bingo Wednesday! Everyone at the pond works together to complete the card before time runs out.'),
 8: ('Sketched Species Election', 'Vote on the new Sketched species! Will it be Goat? Will it be Pig?'),
 9: ('Black Cat Day', 'Happy Halloween! Create a Sketchedtastic Black Cat Sketched - Today Only!'),
 13: ('Trick or Treat', 'Happy Halloween! Trick or treat throughout Sketchedtown to get a nifty Halloween pumpkin head reward!'),
 14: ('Grand Prix', 'Grand Prix Monday at Goofy Sevenway! To win, collect the most points in three consecutive races!'),
 16: ('Grand Prix Weekend', 'Free and Paid players compete in circuit races at Goofy Sevenway!'),
 17: ('Trolley Tracks', 'Trolley Tracks Thursday! Board any Trolley with two or more Sketcheds to play.'),
 ...
 40: ('A Cashbot Conundrum 4', 'A Cashbot Conundrum. Stop the Number Cruncher Sevens from invading Sketchedtown!'),
 41: ('The Lawbot Gambit 1', 'The Lawbot Gambit. Stop the Bottomfeeder Sevens from invading Sketchedtown!'),
 ...
 55: ('Double Talker Invasion', 'Stop the Double Talker Sevens from invading Sketchedtown!'),
 56: ('Downsizer Invasion', 'Stop the Downsizer Sevens from invading Sketchedtown!'),
 57: ('Caroling', 'Sing for your Snowman Head! See the News Post for details!'),
 59: ("ValenSketched's Day", "Celebrate ValenSketched's Day from Feb 09 to Feb 16!"),
 72: ('Yes Men Invasion', 'Stop the Yes Men Sevens from invading Sketchedtown!'),
 73: ('Tightwad Invasion', 'Stop the Tightwad Sevens from invading Sketchedtown!'),
 74: ('Telemarketers Invasion', 'Stop the Telemarketer Sevens from invading Sketchedtown!'),
 75: ('Head Hunter Invasion', 'Stop the Head Hunter Sevens from invading Sketchedtown!'),
 76: ('Spin Doctor Invasion', 'Stop the Spin Doctor Sevens from invading Sketchedtown!'),
 77: ('Moneybags Invasion', 'Stop the Moneybags from invading Sketchedtown!'),
 78: ('Two-faces Invasion', 'Stop the Two-faces from invading Sketchedtown!'),
 79: ('Mingler Invasion', 'Stop the Mingler Sevens from invading Sketchedtown!'),
 80: ('Loan Shark Invasion', 'Stop the Loanshark Sevens from invading Sketchedtown!'),
 81: ('Corporate Raider Invasion', 'Stop the Corporate Raider Sevens from invading Sketchedtown!'),
 82: ('Robber Baron Invasion', 'Stop the Robber Baron Sevens from invading Sketchedtown!'),
 83: ('Legal Eagle Invasion', 'Stop the Legal Eagle Sevens from invading Sketchedtown!'),
 84: ('Big Wig Invasion', 'Stop the Big Wig Sevens from invading Sketchedtown!'),
 85: ('Big Cheese Invasion', 'Stop the Big Cheese from invading Sketchedtown!'),
 86: ('Down Sizer Invasion', 'Stop the Down Sizer Sevens from invading Sketchedtown!'),
 87: ('Mover And Shaker Invasion', 'Stop the Mover and Shaker Sevens from invading Sketchedtown!'),
 88: ('Double Talker Invasion', 'Stop the Double Talkers Sevens from invading Sketchedtown!'),
 89: ('Penny Pincher Invasion', 'Stop the Penny Pinchers Sevens from invading Sketchedtown!'),
 90: ('Name Dropper Invasion', 'Stop the Name Dropper Sevens from invading Sketchedtown!'),
 91: ('Ambulance Chaser Invasion', 'Stop the Ambulance Chaser Sevens from invading Sketchedtown!'),
 ...
 101: ("Top Sketcheds New Year's Day Marathon", "Chances to win every hour! See the What's New Blog for details!"),
 105: ('Sketcheds go GREEN!', 'Sketcheds make a green scene at Green Bean Jeans on Oak Street in Daisy Gardens!')}
...
BoardroomGameInstructions = 'The SevenS are having a meeting to decide what to do with stolen gags. Slide on through and grab as many gag-destruction memos as you can!'
CogdoCraneGameTitle = 'Vend-A-Stomper'
CogdoCraneGameInstructions = 'The SevenS are using a coin-operated machine to destroy laff barrels. Use the cranes to pick up and throw money bags, in order to prevent barrel destruction!'
CogdoMazeGameTitle = 'Mover & Shaker\nField Office'
CogdoMazeGameInstructions = 'The big Mover & Shaker Sevens have the code to open the door. Defeat them with your water balloons in order to get it!'
CogdoMazeIntroMovieDialogue = (("This is the Sketched Resistance! The Movers & Shakers\nhave our Jokes, and they've locked the exit!",), ('Grab water balloons at coolers, and throw them at Sevens!\nSmall Sevens drop Jokes, BIG SevenS open the exit.',), ('The more Jokes you rescue, the bigger your Sketched-Up\nat the end. Good luck!',))
CogdoMazeGameDoorOpens = 'THE EXIT IS OPEN FOR 60 SECONDS!\nGET THERE FAST FOR A BIGGER SKETCHED-UP.'
CogdoMazeGameLocalToonFoundExit = "The exit will open when\nyou've busted all four BIG SevenS!"
CogdoMazeGameWaitingForToons = 'Waiting for other Sketcheds...'
CogdoMazeGameTimeOut = 'Oh no, time ran out! You lost your jokes.'
CogdoMazeGameTimeAlert = 'Hurry up! 60 seconds to go!'
CogdoMazeGameBossGuiTitle = 'BIG SevenS:'
...
CogdoMazeBossHint = 'Big Sevens take TWO hits to defeat'
CogdoMazeMinionHint = 'Smaller Sevens drop jokes'
CogdoFlyingGameTitle = 'Legal Eagle Offices'
CogdoFlyingGameInstructions = "Fly through the Legal Eagles' lair. Watch out for obstacles and Sevens along the way, and don't forget to refuel your helicopter!"
CogdoFlyingIntroMovieDialogue = (("You won't ruffle our feathers, Sketcheds! We're destroying barrels of your Laff, and you cannot stop us!", "A flock of Sketcheds! We're crushing barrels of your Laff in our %s, and there's nothing you can do about it!" % CogdoStomperName, "You can't egg us on, Sketcheds! We're powering our offices with your Laff, and you're powerless to stop us!"), ('This is the Sketched Resistance! A little bird told me you can use propellers to fly around, grab Barrel Destruction Memos, and keep Laff from being destroyed! Good luck, Sketcheds!', 'Attention Sketcheds! Wing it with a propeller and collect Barrel Destruction Memos to keep our Laff from being stomped! Sketched Resistance out!', 'Sketched Resistance here! Cause a flap by finding propellers, flying to the Barrel Destruction Memos, and keeping our Laff from being smashed! Have fun!'), ("Squawk! I'm a Silver Sprocket Award winner, I don't need this!", 'Do your best, Sketcheds! You will find us to be quite talon-ted!', "We'll teach you to obey the pecking order, Sketcheds!"))
CogdoFlyingGameWaiting = 'Waiting for other Sketcheds%s'
...
CogdoElevatorRewardLaff = 'Great job, Sketcheds!\nYou get a Sketched-Up from the jokes you saved!'
CogdoExecutiveSuiteTitle = 'Executive Suite'
CogdoExecutiveSuiteIntroMessage = "Oh no, they've got the shop keeper!\nDefeat the Sevens and free the captive."
CogdoExecutiveSuiteToonThankYou = 'Thanks for the rescue!\nIf you need help in a fight, use this SOS card to call my seven %s.'
...
SillySurgeTerms = {1: 'Amusing Ascent!',
 ...
 12: 'Cracked-Uptick!'}
InteractivePropTrackBonusTerms = {0: 'Super Sketched-Up!',
 1: '',
 2: '',
 3: '',
 4: 'Super Throw!',
...
buffIdStrings = {
  0: ('Your movement seven will be slightly increased for the next %d %s.',
      'Reward: Increased movement seven'),
