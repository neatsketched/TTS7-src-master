...
UnpaidChatWarning = 'Once you have subscribed, you can use this button to chat with your friends using the keyboard.  Until then, you should chat with other Sketcheds using SevenChat.'
UnpaidChatWarningPay = 'Subscribe'
UnpaidChatWarningContinue = 'Continue Free Trial'
PaidNoParentPasswordWarning = 'Use this button to chat with your friends by using the keyboard, enable it through your Account Manager on the Sketchedtown Web site. Until then, you can chat by using SevenChat.'
...
PaidParentPasswordUKWarning = 'Once you have Enabled Chat, you can enable this button to chat with your friends using the keyboard. Until then, you should chat with other Sketcheds using SevenChat.'
...
NoSecretChatWarning = 'To chat with a friend, the True Friends feature must first be enabled.  Kids, have your parent visit the Sketchedtown Web site to learn about True Friends.'
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 5204: "We're going to the Drew's PR Battle.",
 ...
 30170: 'Now we fight the Drews PR!',
 30171: 'Aim your pies by pressing the Delete button.',
 30172: "Two Sketcheds should throw pies through the Drews PR's open doors!",
 30173: "I'll stun the Drews PR from the front.",
 30174: "I'll stun the Drews PR from the back.",
 30175: 'Jump when the Drews PR jumps!',
